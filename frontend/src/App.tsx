...
import { ContentPolicyScanPanel } from "./features/connectors/ContentPolicyScanPanel";
import {
                                                              ...
                                                              {builderPackageInventoryMutation.data?.data && (
                                                                <section className="mcp-builder-validation">
                                                                  ...
                                                                  {builderPackageInventoryMutation.data?.data
                                                                    .outcome === "passed" &&
                                                                    identity && (
                                                                      <ContentPolicyScanPanel
                                                                        key={builderPackageInventoryMutation.data.data.inventory_id}
                                                                        source={builderPackageInventoryMutation.data.data}
                                                                        subjectId={identity.subject_id}
                                                                      />
                                                                    )}
                                                            </section>
