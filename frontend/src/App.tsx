...
import { AuthorityBehaviorPanel } from "./features/connectors/AuthorityBehaviorPanel";
import {
                                                              ...
                                                              {builderSchemaSemanticsMutation.data?.data
                                                                ...
                                                                identity && (
                                                                  <AuthorityBehaviorPanel
                                                                    key={builderSchemaSemanticsMutation.data.data.validation_id}
                                                                    source={builderSchemaSemanticsMutation.data.data}
                                                                    subjectId={identity.subject_id}
                                                                  />
                                                                )}
                                                            </section>
