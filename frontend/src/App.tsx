...
import { SchemaSemanticsPanel } from "./features/connectors/SchemaSemanticsPanel";
import {
                                                              ...
                                                              {builderContentPolicyScanMutation.data?.data
                                                                ...
                                                                identity && (
                                                                  <SchemaSemanticsPanel
                                                                    key={builderContentPolicyScanMutation.data.data.scan_id}
                                                                    source={builderContentPolicyScanMutation.data.data}
                                                                    subjectId={identity.subject_id}
                                                                  />
                                                                )}
                                                            </section>
