...
describe("ConnectorLifecycleOverview", () => {
  it("distinguishes platform coverage from instance authority", () => {
    ...
    expect(screen.getByLabelText("Delivery status")).toHaveTextContent(
      "10Available stages0In progressRecommendation human review findingsLatest available capability",
    );
    ...
    expect(screen.getAllByText("Recommendation human review findings")).toHaveLength(2);
