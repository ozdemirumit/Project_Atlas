...
describe("ConnectorLifecycleOverview", () => {
  it("distinguishes platform coverage from instance authority", () => {
    ...
    expect(screen.getByLabelText("Delivery status")).toHaveTextContent(
      "10Available stages0In progressRecommendation review readinessLatest available capability",
    );
    ...
    expect(screen.getAllByText("Recommendation review readiness")).toHaveLength(2);
