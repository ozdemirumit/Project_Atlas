...
describe("ConnectorLifecycleOverview", () => {
  it("distinguishes platform coverage from instance authority", () => {
    ...
    expect(screen.getByLabelText("Delivery status")).toHaveTextContent(
      "10Available stages0In progressRecommendation content presentationLatest available capability",
    );
    ...
    expect(screen.getAllByText("Recommendation content presentation")).toHaveLength(2);
