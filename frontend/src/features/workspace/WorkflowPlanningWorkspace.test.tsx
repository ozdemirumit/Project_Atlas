...
const targetContextCapsuleOpeningAuthorizationLease: WorkflowPhysicalTransportTargetContextCapsuleOpeningAuthorizationLease = {
  authorization_lease_id:
  ...
  valid_until: "2026-08-14T10:08:27Z",
  single_use: true,
  renewable: false,
  transferable: false,
  lease_is_bearer_capability: false,
  ...
  integrity_reference:
    "integrity.workflow-target-context-capsule-opening-lease.1234567890abcdef",
};

const targetContextCapsuleOpening: WorkflowPhysicalTransportTargetContextCapsuleOpening = {
  ...
  resident_context_profile_reference:
    "integrity.workflow-target-context-capsule-resident-context-profile.1234567890abcdef",
...
const protectedResidentContextAccessConsumption: WorkflowProtectedResidentContextAccessConsumption = {
  access_id: "workflow-protected-resident-context-access.1234567890abcdef",
  attempt_state: "completed",
  result_state: "handle_established_in_protected_boundary",
  started_at: "2026-08-14T10:08:28Z",
  completed_at: "2026-08-14T10:08:28.250Z",
  consumer_contract_id:
    "contract.workflow-protected-transport-target-context-capsule-consumer",
  consumer_contract_version: "1.0",
  ...
  accessor_profile_reference:
    "integrity.workflow-protected-resident-context-accessor-profile.1234567890abcdef",
  runtime_profile_reference:
    "integrity.workflow-protected-runtime-context-profile.1234567890abcdef",
...
const protectedRuntimeContextUseAuthorization: WorkflowProtectedRuntimeContextUseAuthorization = {
  authorization_lease_id:
    "workflow-protected-runtime-context-use-lease.1234567890abcdef12345678",
  state: "authorized_unconsumed",
  effective_state: "active",
  issued_at: "2026-08-14T10:08:28Z",
  valid_until: "2026-08-14T10:08:29Z",
  ...
  use_profile_reference:
    "integrity.workflow-protected-runtime-context-use-profile.1234567890abcdef",
  runtime_slot_profile_reference:
    "integrity.workflow-protected-runtime-slot-profile.1234567890abcdef",
  destination_profile_reference:
    "integrity.workflow-protected-destination-profile.1234567890abcdef",
...
const protectedRuntimeContextUse: WorkflowProtectedRuntimeContextUse = {
  use_id: "workflow-protected-runtime-context-use.1234567890abcdef12345678",
  attempt_state: "completed",
  result_state: "context_used_once_in_protected_boundary",
  started_at: "2026-08-14T10:08:29Z",
  completed_at: "2026-08-14T10:08:29.250Z",
  context_use_performed: true,
  policy_id: "policy.workflow-protected-runtime-context-use",
  policy_version: "1.0",
  use_profile_reference:
    "integrity.workflow-protected-runtime-context-use-profile.1234567890abcdef",
  authority: { ...protectedRuntimeContextUseAuthorizationConsumption.authority },
  integrity_reference:
...
const protectedRuntimeReadinessAuthorization: WorkflowProtectedRuntimeReadinessAuthorization = {
  authorization_lease_id:
    "workflow-protected-runtime-readiness-lease.1234567890abcdef12345678",
  state: "authorized_unconsumed",
  effective_state: "active",
...
const protectedRuntimeContextInjectionConsumption: WorkflowProtectedRuntimeContextInjectionConsumption = {
  ...
  attempt_state: "completed",
  result_state: "injected_into_protected_runtime_slot",
  started_at: "2026-08-14T10:08:28Z",
  completed_at: "2026-08-14T10:08:28.250Z",
  ...
  runtime_slot_profile_reference:
    "integrity.workflow-protected-runtime-slot-profile.1234567890abcdef",
  integrity_reference:
    "integrity.workflow-protected-runtime-context-injection-consumption.1234567890abcdef",
};
...
function targetContextCapsuleOpeningAuthorizationLeaseResponse(
  leases: unknown[],
  status = 200,
  serverTime = "2026-08-14T10:08:26.500Z",
  durable = true,
): Response {
  return new Response(
    status === 200
      ? JSON.stringify({
          data: {
            physical_transport_target_context_capsule_opening_authorization_leases: leases,
            server_time: serverTime,
            durable,
          },
          meta: {
            correlation_id:
              "correlation.workflow.target-context-capsule-opening-authorization-lease",
            generated_at: serverTime,
          },
        })
      : null,
...
function targetContextCapsuleOpeningResponse(
  openings: unknown[],
  status = 200,
  serverTime = "2026-08-14T10:08:28Z",
  durable = true,
): Response {
  return new Response(
    status === 200
      ? JSON.stringify({
          data: {
            physical_transport_target_context_capsule_openings: openings,
            server_time: serverTime,
            durable,
          },
          meta: {
            correlation_id: "correlation.workflow.target-context-capsule-opening",
            generated_at: serverTime,
          },
        })
      : null,
...
function protectedResidentContextAccessConsumptionResponse(
  ...
  return new Response(
    status === 200
      ? JSON.stringify({
          ...
          meta: {
            correlation_id: "correlation.workflow.protected-resident-context-access-consumption",
            generated_at: serverTime,
          },
        })
      : null,
...
function protectedRuntimeContextUseAuthorizationResponse(
  authorizations: unknown[],
  status = 200,
  serverTime = "2026-08-14T10:08:28.500Z",
  durable = true,
  ...
  return new Response(
    status === 200
      ? JSON.stringify({
          ...
          meta: {
            correlation_id:
              "correlation.workflow.protected-runtime-context-use-authorization",
            generated_at: serverTime,
          },
        })
      : null,
...
function protectedRuntimeContextUseResponse(
  uses: unknown[],
  status = 200,
  serverTime = "2026-08-14T10:08:30Z",
  durable = true,
): Response {
  return new Response(
    status === 200
      ? JSON.stringify({
          data: { uses, server_time: serverTime, durable },
          meta: {
            correlation_id: "correlation.workflow.protected-runtime-context-use",
            generated_at: serverTime,
          },
        })
      : null,
...
function protectedRuntimeReadinessAuthorizationResponse(
  authorizations: unknown[],
  status = 200,
  serverTime = "2026-08-14T10:08:32.500Z",
  durable = true,
): Response {
  return new Response(
    status === 200
      ? JSON.stringify({
          ...
          meta: {
            correlation_id:
              "correlation.workflow.protected-runtime-readiness-authorization",
            generated_at: serverTime,
          },
        })
      : null,
  ...
  return new Response(
    status === 200
      ? JSON.stringify({
          ...
          meta: {
            correlation_id:
              "correlation.workflow.protected-runtime-context-injection-consumption",
            generated_at: serverTime,
          },
        })
      : null,
...
function mockReadResponses(input: {
  ...
  targetContextCapsuleOpeningAuthorizationLeases?: unknown[];
  targetContextCapsuleOpeningAuthorizationLeaseServerTime?: string;
  targetContextCapsuleOpeningAuthorizationLeaseDurable?: boolean;
  ...
  protectedRuntimeContextInjectionConsumptions?: unknown[];
  protectedRuntimeContextInjectionConsumptionServerTime?: string;
  protectedRuntimeContextInjectionConsumptionDurable?: boolean;
  ...
  targetContextCapsuleOpeningAuthorizationLeaseStatus?: number;
  ...
  protectedRuntimeContextInjectionConsumptionStatus?: number;
  ...
  vi.mocked(fetch).mockImplementation((request) => {
    ...
    if (url.endsWith("/api/v1/workflows/protected-runtime-readiness-authorizations")) {
      ...
      const status =
        input.protectedRuntimeReadinessAuthorizationStatuses?.[
          Math.min(
            protectedRuntimeReadinessAuthorizationReadCount++,
            input.protectedRuntimeReadinessAuthorizationStatuses.length - 1,
          )
        ] ?? input.protectedRuntimeReadinessAuthorizationStatus ?? 200;
      return Promise.resolve(
        protectedRuntimeReadinessAuthorizationResponse(
          input.protectedRuntimeReadinessAuthorizations ?? [],
          status,
          input.protectedRuntimeReadinessAuthorizationServerTime,
          input.protectedRuntimeReadinessAuthorizationDurable,
        ),
      );
    }
    ...
    if (url.endsWith("/api/v1/workflows/protected-runtime-context-uses")) {
      ...
      const status =
        input.protectedRuntimeContextUseStatuses?.[
          Math.min(
            protectedRuntimeContextUseReadCount++,
            input.protectedRuntimeContextUseStatuses.length - 1,
          )
        ] ?? input.protectedRuntimeContextUseStatus ?? 200;
      return Promise.resolve(
        protectedRuntimeContextUseResponse(
          input.protectedRuntimeContextUses ?? [],
          status,
          input.protectedRuntimeContextUseServerTime,
          input.protectedRuntimeContextUseDurable,
        ),
      );
    }
    if (
    ...
    if (url.endsWith("/api/v1/workflows/protected-runtime-context-use-authorizations")) {
      ...
      const status =
        input.protectedRuntimeContextUseAuthorizationStatuses?.[
          Math.min(
            protectedRuntimeContextUseAuthorizationReadCount++,
            input.protectedRuntimeContextUseAuthorizationStatuses.length - 1,
          )
        ] ?? input.protectedRuntimeContextUseAuthorizationStatus ?? 200;
      return Promise.resolve(
        protectedRuntimeContextUseAuthorizationResponse(
          input.protectedRuntimeContextUseAuthorizations ?? [],
          status,
          input.protectedRuntimeContextUseAuthorizationServerTime,
          input.protectedRuntimeContextUseAuthorizationDurable,
        ),
      );
    }
    if (url.endsWith("/api/v1/workflows/protected-runtime-context-injection-consumptions")) {
      if (input.pendingProtectedRuntimeContextInjectionConsumptionResponse) {
        return input.pendingProtectedRuntimeContextInjectionConsumptionResponse;
      }
      const status =
        input.protectedRuntimeContextInjectionConsumptionStatuses?.[
          Math.min(
            protectedRuntimeContextInjectionConsumptionReadCount++,
            input.protectedRuntimeContextInjectionConsumptionStatuses.length - 1,
          )
        ] ?? input.protectedRuntimeContextInjectionConsumptionStatus ?? 200;
      return Promise.resolve(
        protectedRuntimeContextInjectionConsumptionResponse(
          input.protectedRuntimeContextInjectionConsumptions ?? [],
          status,
          input.protectedRuntimeContextInjectionConsumptionServerTime,
          input.protectedRuntimeContextInjectionConsumptionDurable,
        ),
      );
    }
    if (
    ...
    if (url.endsWith("/api/v1/workflows/protected-resident-context-access-consumptions")) {
      ...
      const status =
        input.protectedResidentContextAccessConsumptionStatuses?.[
          Math.min(
            protectedResidentContextAccessConsumptionReadCount++,
            input.protectedResidentContextAccessConsumptionStatuses.length - 1,
          )
        ] ?? input.protectedResidentContextAccessConsumptionStatus ?? 200;
      return Promise.resolve(
        protectedResidentContextAccessConsumptionResponse(
          input.protectedResidentContextAccessConsumptions ?? [],
          status,
          input.protectedResidentContextAccessConsumptionServerTime,
          input.protectedResidentContextAccessConsumptionDurable,
        ),
      );
    }
    ...
    if (url.endsWith("/api/v1/workflows/physical-transport-target-context-capsule-openings")) {
      ...
      const status =
        input.targetContextCapsuleOpeningStatuses?.[
          Math.min(
            targetContextCapsuleOpeningReadCount++,
            input.targetContextCapsuleOpeningStatuses.length - 1,
          )
        ] ?? input.targetContextCapsuleOpeningStatus ?? 200;
      return Promise.resolve(
        targetContextCapsuleOpeningResponse(
          input.targetContextCapsuleOpenings ?? [],
          status,
          input.targetContextCapsuleOpeningServerTime,
          input.targetContextCapsuleOpeningDurable,
        ),
      );
    }
    if (
      ...
      if (input.pendingTargetContextCapsuleOpeningAuthorizationLeaseResponse) {
        return input.pendingTargetContextCapsuleOpeningAuthorizationLeaseResponse;
      }
      const status =
        input.targetContextCapsuleOpeningAuthorizationLeaseStatuses?.[
          Math.min(
            targetContextCapsuleOpeningAuthorizationLeaseReadCount++,
            input.targetContextCapsuleOpeningAuthorizationLeaseStatuses.length - 1,
          )
        ] ?? input.targetContextCapsuleOpeningAuthorizationLeaseStatus ?? 200;
      return Promise.resolve(
        targetContextCapsuleOpeningAuthorizationLeaseResponse(
          input.targetContextCapsuleOpeningAuthorizationLeases ?? [],
          status,
          input.targetContextCapsuleOpeningAuthorizationLeaseServerTime,
          input.targetContextCapsuleOpeningAuthorizationLeaseDurable,
        ),
      );
    }
...
describe("WorkflowPlanningWorkspace", () => {
  ...
  it("accepts the canonical backend capsule opening authorization response as minimized read-only evidence", async () => {
    ...
    const expiredLease: WorkflowPhysicalTransportTargetContextCapsuleOpeningAuthorizationLease = {
      ...
      authorization_lease_id:
        "workflow-target-context-capsule-opening-authorization-lease.abcdef1234567890",
      issued_at: "2026-08-14T10:08:25Z",
      valid_until: "2026-08-14T10:08:26Z",
      effective_state: "expired",
    };
    mockReadResponses({
      targetContextCapsuleOpeningAuthorizationLeases: [
        targetContextCapsuleOpeningAuthorizationLease,
        expiredLease,
      ],
    });
    ...
    const section = (await screen.findByRole("heading", {
      name: "Target-context capsule opening authorization leases",
    })).closest("section") as HTMLElement;
    const records = await within(section).findByRole("list", {
      name: "Target-context capsule opening authorization leases",
    });
    ...
    expect(
      within(section).getByTitle(
        targetContextCapsuleOpeningAuthorizationLease.authorization_lease_id,
      ),
    ).toBeVisible();
    expect(records).toHaveTextContent("Active");
    expect(records).toHaveTextContent("Expired");
    ...
    expect(section).not.toHaveTextContent(
      /handoff[-_ ]?(?:id|digest)|capsule[-_ ]?(?:id|digest)|receipt[-_ ]?(?:id|digest)|opening[-_ ]?(?:id|digest)|artifact[-_ ]?(?:id|digest)|attestation|idempotency|request fingerprint|fenc(?:e|ing)|locator|endpoint[-_ ]?(?:id|host|address)|credential[-_ ]?(?:id|material|token|secret)/i,
    );
    expect(section).not.toHaveTextContent(/\bMFA\b|second login|authorized browser session/i);
  });

  it("renders empty and loading capsule opening authorization lease states without controls", async () => {
    mockReadResponses({ targetContextCapsuleOpeningAuthorizationLeases: [] });
    const view = renderWorkspace();
    let section = (await screen.findByRole("heading", {
      name: "Target-context capsule opening authorization leases",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText(
        "No capsule opening authorization leases are recorded in this scope.",
      ),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    ...
    view.unmount();
    mockReadResponses({
      pendingTargetContextCapsuleOpeningAuthorizationLeaseResponse: new Promise<Response>(
        () => undefined,
      ),
    });
    renderWorkspace();
    ...
    expect(
      await within(section).findByText(
        "Loading capsule opening authorization lease evidence...",
      ),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
  ...
  it("fails closed when capsule opening authorization storage is not durable", async () => {
    mockReadResponses({
      targetContextCapsuleOpeningAuthorizationLeases: [
        targetContextCapsuleOpeningAuthorizationLease,
      ],
      targetContextCapsuleOpeningAuthorizationLeaseDurable: false,
    });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Target-context capsule opening authorization leases",
    ...
    expect(
      await within(section).findByText("Capsule opening authorization leases are unavailable"),
    ).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    expect(within(section).queryByRole("button")).toBeNull();
  });
  ...
  it.each([
    ...
    [
      ...
      "current role or scope cannot inspect capsule opening authorization lease evidence",
    ],
    [
      503,
      "Capsule opening authorization leases are unavailable",
      "No opening authority, capsule state, or operational state is inferred",
    ],
  ])(
    "handles capsule opening authorization lease read status %s in the normal browser session",
    async (status, title, detail) => {
      mockReadResponses({ targetContextCapsuleOpeningAuthorizationLeaseStatus: status });
      renderWorkspace();
      const section = (await screen.findByRole("heading", {
        name: "Target-context capsule opening authorization leases",
      })).closest("section") as HTMLElement;
  ...
  it.each([
    [
      ...
      { ...targetContextCapsuleOpeningAuthorizationLease, handoff_id: "handoff.hidden" },
    ],
    [
      "a capsule identifier",
      { ...targetContextCapsuleOpeningAuthorizationLease, capsule_id: "capsule.hidden" },
    ],
    [
      "a consumer receipt",
      { ...targetContextCapsuleOpeningAuthorizationLease, consumer_receipt_id: "receipt.hidden" },
    ],
    [
      "an attestation",
    ...
    [
      "an extra authority",
      {
        ...targetContextCapsuleOpeningAuthorizationLease,
        authority: {
          ...targetContextCapsuleOpeningAuthorizationLease.authority,
          consume_authorized: false,
        },
      },
    ],
    [
      "missing opening authority",
      {
        ...targetContextCapsuleOpeningAuthorizationLease,
        authority: {
          ...targetContextCapsuleOpeningAuthorizationLease.authority,
    ...
    [
      "a bearer capability",
      { ...targetContextCapsuleOpeningAuthorizationLease, lease_is_bearer_capability: true },
    ],
    [
      "a shortened lifetime",
      {
        ...targetContextCapsuleOpeningAuthorizationLease,
        valid_until: "2026-08-14T10:08:26.999Z",
      },
    ],
    [
      "a mismatched scope",
      {
        ...targetContextCapsuleOpeningAuthorizationLease,
        scope: { ...plan.scope, site_id: "site.other" },
      },
    ],
  ])(
    "fails closed when a capsule opening authorization lease contains %s",
    async (_case, unsafe) => {
      mockReadResponses({ targetContextCapsuleOpeningAuthorizationLeases: [unsafe] });
      renderWorkspace();
      const section = (await screen.findByRole("heading", {
        name: "Target-context capsule opening authorization leases",
      })).closest("section") as HTMLElement;
  ...
  it("renders canonical target-context capsule openings as minimized read-only evidence", async () => {
    expect(Object.keys(targetContextCapsuleOpening).sort()).toEqual(
      [
        "opening_id",
        "scope",
        "attempt_state",
    ...
    const uncertainOpening: WorkflowPhysicalTransportTargetContextCapsuleOpening = {
      ...targetContextCapsuleOpening,
      opening_id: "workflow-target-context-capsule-opening.abcdef1234567890",
      attempt_state: "started",
      result_state: "opening_outcome_uncertain",
      completed_at: null,
      capsule_opened_in_protected_boundary: false,
      target_context_pair_verified: false,
    };
    mockReadResponses({
      targetContextCapsuleOpenings: [targetContextCapsuleOpening, uncertainOpening],
    });
    renderWorkspace();

    const section = (await screen.findByRole("heading", {
      name: "Target-context capsule openings",
    })).closest("section") as HTMLElement;
    const records = await within(section).findByRole("list", {
      name: "Target-context capsule openings",
    });
    ...
    expect(within(section).getByTitle(targetContextCapsuleOpening.opening_id)).toBeVisible();
    expect(records).toHaveTextContent("opened in protected boundary");
    expect(records).toHaveTextContent("opening outcome uncertain");
    expect(
      within(section).getAllByTitle(targetContextCapsuleOpening.consumer_contract_id)[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(targetContextCapsuleOpening.purpose_id)[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(targetContextCapsuleOpening.opener_contract_id)[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(
        targetContextCapsuleOpening.resident_context_profile_reference,
      )[0],
    ).toBeVisible();
    expect(records).toHaveTextContent(
      "Capsule opened in protected boundary true | target-context pair verified true | resident context bearer capability false",
    );
    expect(records).toHaveTextContent(
      /all authorities false: target-context capsule opening false.*target-context capsule handoff false.*endpoint resolution false.*route selection false.*route binding false.*credential selection false.*credential assignment binding false.*credential access false.*credential brokerage false.*credential resolution false.*protected artifact access false.*credential delivery false.*network access false.*readiness probe false.*publication false.*delivery false.*dispatch false.*execution false.*infrastructure mutation false/i,
    );
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    expect(within(section).queryByRole("textbox")).toBeNull();
    expect(within(section).queryByRole("combobox")).toBeNull();
    expect(section).not.toHaveTextContent(
      /lease\.hidden|capsule\.hidden|receipt\.hidden|binding\.hidden|destination\.hidden|attestation\.hidden|resident-context\.hidden|idempotency\.hidden|fence\.hidden/i,
    );
  });

  it("renders empty and loading target-context capsule opening states without controls", async () => {
    mockReadResponses({ targetContextCapsuleOpenings: [] });
    const view = renderWorkspace();
    let section = (await screen.findByRole("heading", {
      name: "Target-context capsule openings",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText(
        "No target-context capsule openings are recorded in this scope.",
      ),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    ...
    view.unmount();
    mockReadResponses({
      pendingTargetContextCapsuleOpeningResponse: new Promise<Response>(() => undefined),
    });
    renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Target-context capsule openings",
    ...
    expect(
      await within(section).findByText("Loading target-context capsule opening evidence..."),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
  });
  ...
  it.each([
    [403, "Capsule opening evidence permission is missing", "current role or scope cannot inspect"],
    [503, "Capsule opening evidence is unavailable", "No opening result"],
  ])(
    "fails closed for target-context capsule opening read status %s",
    async (status, title, detail) => {
      mockReadResponses({ targetContextCapsuleOpeningStatus: status });
      renderWorkspace();
      const section = (await screen.findByRole("heading", {
        name: "Target-context capsule openings",
      })).closest("section") as HTMLElement;
  ...
  it.each([
    [
      "a protected capsule identifier",
      { ...targetContextCapsuleOpening, capsule_id: "capsule.hidden" },
    ],
    [
      "an unexpected opener contract",
      {
        ...targetContextCapsuleOpening,
        opener_contract_id: "contract.workflow-protected-transport-target-context-other-opener",
      },
    ],
    [
      "an unsafe resident-context profile",
      {
        ...targetContextCapsuleOpening,
        resident_context_profile_reference: "resident-context.hidden",
      },
    ],
    [
      "opening authority",
      {
        ...targetContextCapsuleOpening,
        authority: {
          ...targetContextCapsuleOpening.authority,
          target_context_capsule_opening_authorized: true,
        },
      },
    ],
    ...
    [
      "an inconsistent successful result",
      { ...targetContextCapsuleOpening, target_context_pair_verified: false },
    ],
    [
      "an unsafe integrity reference",
      { ...targetContextCapsuleOpening, integrity_reference: "integrity.workflow.other" },
    ],
  ])("rejects a malformed target-context capsule opening with %s", async (_case, unsafe) => {
    mockReadResponses({ targetContextCapsuleOpenings: [unsafe] });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Target-context capsule openings",
    })).closest("section") as HTMLElement;
    ...
    expect(
      within(section).queryByRole("list", { name: "Target-context capsule openings" }),
    ).toBeNull();
    expect(section).not.toHaveTextContent(/capsule\.hidden|resident-context\.hidden/i);
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
  });

  it("rejects a non-durable target-context capsule opening inventory", async () => {
    mockReadResponses({
      targetContextCapsuleOpenings: [targetContextCapsuleOpening],
      targetContextCapsuleOpeningDurable: false,
    });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Target-context capsule openings",
  ...
  it("renders protected resident-context access consumptions as exact read-only evidence", async () => {
    expect(Object.keys(protectedResidentContextAccessConsumption).sort()).toEqual(
      [
        "access_id",
        "attempt_state",
        "result_state",
    ...
    mockReadResponses({
      protectedResidentContextAccessConsumptions: [
        protectedResidentContextAccessConsumption,
      ],
    });
    renderWorkspace();

    const section = (await screen.findByRole("heading", {
      name: "Protected resident-context access consumptions",
    })).closest("section") as HTMLElement;
    const records = await within(section).findByRole("list", {
      name: "Protected resident-context access consumptions",
    });
    ...
    expect(
      within(section).getByTitle(protectedResidentContextAccessConsumption.access_id),
    ).toBeVisible();
    expect(records).toHaveTextContent("handle established in protected boundary");
    expect(
      within(section).getByTitle(
        protectedResidentContextAccessConsumption.accessor_profile_reference,
      ),
    ).toBeVisible();
    expect(
      within(section).getByTitle(
        protectedResidentContextAccessConsumption.runtime_profile_reference,
      ),
    ).toBeVisible();
    expect(records).toHaveTextContent(
  ...
  it("fails closed for unsafe or unavailable resident-context access consumption evidence", async () => {
    mockReadResponses({ protectedResidentContextAccessConsumptionStatus: 503 });
    const view = renderWorkspace();
    let section = (await screen.findByRole("heading", {
      name: "Protected resident-context access consumptions",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Resident-context access consumptions are unavailable"),
    ).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    ...
    mockReadResponses({
      protectedResidentContextAccessConsumptions: [
        {
          ...protectedResidentContextAccessConsumption,
          authorization_lease_id: "workflow-protected-resident-context-access-lease.hidden",
        },
      ],
    });
    renderWorkspace();
  ...
  it("renders protected runtime-context use authorizations as minimized read-only evidence", async () => {
    expect(Object.keys(protectedRuntimeContextUseAuthorization).sort()).toEqual(
      [
        "authorization_lease_id",
        "state",
        "effective_state",
    ...
    expect(Object.keys(protectedRuntimeContextUseAuthorization.authority)).toHaveLength(26);
    expect(
      Object.entries(protectedRuntimeContextUseAuthorization.authority).filter(
        ([, granted]) => granted,
      ),
    ).toEqual([["protected_runtime_context_use_authority_granted", true]]);
    const expiredAuthorization: WorkflowProtectedRuntimeContextUseAuthorization = {
      ...protectedRuntimeContextUseAuthorization,
      authorization_lease_id:
        "workflow-protected-runtime-context-use-lease.abcdef1234567890abcdef12",
      issued_at: "2026-08-14T10:08:27Z",
      valid_until: "2026-08-14T10:08:28Z",
      effective_state: "expired",
      authority: {
        ...protectedRuntimeContextUseAuthorization.authority,
        protected_runtime_context_use_authority_granted: false,
      },
    };
    mockReadResponses({
      protectedRuntimeContextUseAuthorizations: [
        protectedRuntimeContextUseAuthorization,
        expiredAuthorization,
      ],
    });
    ...
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextUseAuthorization.use_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextUseAuthorization.runtime_slot_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextUseAuthorization.destination_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(protectedRuntimeContextUseAuthorization.policy_id)[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(protectedRuntimeContextUseAuthorization.integrity_reference)[0],
    ).toBeVisible();
    expect(records).toHaveTextContent(
      /protected runtime-context use true.*runtime use false.*runtime start false.*runtime resume false.*connector activity false.*protected runtime-context injection false.*protected resident-context access false.*target-context capsule opening false.*target-context capsule handoff false.*endpoint resolution false.*route selection false.*route binding false.*credential selection false.*credential assignment binding false.*credential access false.*credential brokerage false.*credential resolution false.*protected artifact access false.*credential delivery false.*network access false.*readiness probe false.*publication false.*delivery false.*dispatch false.*execution false.*infrastructure mutation false/i,
    );
    expect(section).toHaveTextContent(/Future-request-only authorization evidence/i);
    expect(section).not.toHaveTextContent(/authorized browser session|MFA/i);
    expect(section).not.toHaveTextContent(
      /source-result\.hidden|slot\.hidden|generation\.hidden|fence\.hidden|receipt\.hidden|attestation\.hidden|nonce\.hidden|idempotency\.hidden|endpoint\.hidden|credential\.hidden/i,
    );
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    expect(within(section).queryByRole("textbox")).toBeNull();
    expect(within(section).queryByRole("combobox")).toBeNull();
    expect(within(section).queryByRole("checkbox")).toBeNull();
    expect(records).toHaveClass(
      "workflow-step-preview",
      "workflow-physical-route-binding-list",
      "workflow-target-context-opening-list",
    );
    expect(records.querySelectorAll(".workflow-physical-route-binding-grid")).toHaveLength(2);
    expect(records).not.toHaveTextContent(
      protectedRuntimeContextUseAuthorization.authorization_lease_id,
    );
  });

  it("shows loading, empty and fail-closed runtime-context use authorization states", async () => {
    mockReadResponses({
      pendingProtectedRuntimeContextUseAuthorizationResponse: new Promise<Response>(() => {}),
    });
    ...
    expect(
      within(section).getByText("Loading protected runtime-context use authorization evidence..."),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();

    loadingView.unmount();
    mockReadResponses({ protectedRuntimeContextUseAuthorizations: [] });
    ...
    emptyView.unmount();
    mockReadResponses({ protectedRuntimeContextUseAuthorizationStatus: 503 });
    renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-context use authorizations",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Runtime-context use authorizations are unavailable"),
    ).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    expect(within(section).queryByRole("button")).toBeNull();
  });
  ...
  it.each([
    [
      "a source result field",
      {
        ...protectedRuntimeContextUseAuthorization,
        source_injection_result_id: "source-result.hidden",
      },
    ],
    [
      "an active lease without dedicated authority",
      {
        ...protectedRuntimeContextUseAuthorization,
        authority: {
          ...protectedRuntimeContextUseAuthorization.authority,
    ...
    [
      "an expired lease with dedicated authority",
      {
        ...protectedRuntimeContextUseAuthorization,
        issued_at: "2026-08-14T10:08:27Z",
        valid_until: "2026-08-14T10:08:28Z",
    ...
    [
      "a slot generation field",
      {
        ...protectedRuntimeContextUseAuthorization,
        slot_generation: "generation.hidden",
      },
    ],
  ])("fails closed for protected runtime-context use authorization with %s", async (_case, unsafe) => {
    mockReadResponses({ protectedRuntimeContextUseAuthorizations: [unsafe] });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context use authorizations",
    })).closest("section") as HTMLElement;
    ...
    expect(within(section).queryByRole("list")).toBeNull();
    expect(section).not.toHaveTextContent(/source-result\.hidden|generation\.hidden/i);
  });

  it("uses the existing username/password session for runtime-context use authorization reads", async () => {
    mockReadResponses({ protectedRuntimeContextUseAuthorizationStatus: 401 });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context use authorizations",
    })).closest("section") as HTMLElement;
  ...
  it("renders protected runtime-context use outcomes as minimized read-only evidence after authorization consumptions", async () => {
    expect(Object.keys(protectedRuntimeContextUse).sort()).toEqual(
      [
        "use_id",
        "attempt_state",
        "result_state",
    ...
    expect(Object.keys(protectedRuntimeContextUse.authority)).toHaveLength(26);
    expect(
      Object.values(protectedRuntimeContextUse.authority).every(
        (granted) => granted === false,
      ),
    ).toBe(true);
    const failedUse: WorkflowProtectedRuntimeContextUse = {
      ...protectedRuntimeContextUse,
      use_id: "workflow-protected-runtime-context-use.abcdef1234567890abcdef12",
      result_state: "context_use_failed_without_use",
      completed_at: "2026-08-14T10:08:29.500Z",
      context_use_performed: false,
      integrity_reference:
        "integrity.workflow-protected-runtime-context-use.abcdef1234567890",
    };
    const uncertainUse: WorkflowProtectedRuntimeContextUse = {
      ...protectedRuntimeContextUse,
      use_id: "workflow-protected-runtime-context-use.0123456789abcdef01234567",
      result_state: "context_use_outcome_uncertain",
      completed_at: "2026-08-14T10:08:29.750Z",
      context_use_performed: null,
      integrity_reference:
        "integrity.workflow-protected-runtime-context-use.0123456789abcdef",
    };
    const pendingUse: WorkflowProtectedRuntimeContextUse = {
      ...protectedRuntimeContextUse,
      use_id: "workflow-protected-runtime-context-use.fedcba9876543210fedcba98",
      attempt_state: "started",
      result_state: "use_pending",
      completed_at: null,
      context_use_performed: null,
      integrity_reference:
        "integrity.workflow-protected-runtime-context-use.fedcba9876543210",
    };
    const claimOnlyUncertainUse: WorkflowProtectedRuntimeContextUse = {
      ...pendingUse,
      use_id: "workflow-protected-runtime-context-use.a1b2c3d4e5f60718a1b2c3d4",
      result_state: "context_use_outcome_uncertain",
      integrity_reference:
        "integrity.workflow-protected-runtime-context-use.a1b2c3d4e5f60718",
    };
    mockReadResponses({
      protectedRuntimeContextUses: [
        protectedRuntimeContextUse,
        failedUse,
        uncertainUse,
        pendingUse,
        claimOnlyUncertainUse,
      ],
    });
    renderWorkspace();

    const consumptionSection = (await screen.findByRole("heading", {
      name: "Protected runtime-context use-authorization consumptions",
    })).closest("section") as HTMLElement;
    const section = (await screen.findByRole("heading", {
    ...
    expect(
      consumptionSection.compareDocumentPosition(section) & Node.DOCUMENT_POSITION_FOLLOWING,
    ).toBeTruthy();
    ...
    expect(
      vi.mocked(fetch).mock.calls.some(([request]) => {
        ...
        return (
          requestedUrl.endsWith("/api/v1/workflows/protected-runtime-context-uses") &&
          requestedMethod === "GET"
        );
      }),
    ).toBe(true);
    expect(records).toHaveTextContent("Context used once");
    expect(records).toHaveTextContent("Failed without context use");
    expect(records).toHaveTextContent("Outcome uncertain");
    expect(records).toHaveTextContent("Use pending");
    expect(records).toHaveTextContent(/Context use performed true/i);
    expect(records).toHaveTextContent(/Context use performed false/i);
    expect(records).toHaveTextContent(/Context use performed unknown/i);
    expect(records).toHaveTextContent(
      /protected runtime-context use false.*runtime use false.*runtime start false.*runtime resume false.*connector activity false.*protected runtime-context injection false.*protected resident-context access false.*target-context capsule opening false.*target-context capsule handoff false.*endpoint resolution false.*route selection false.*route binding false.*credential selection false.*credential assignment binding false.*credential access false.*credential brokerage false.*credential resolution false.*protected artifact access false.*credential delivery false.*network access false.*readiness probe false.*publication false.*delivery false.*dispatch false.*execution false.*infrastructure mutation false/i,
    );
    expect(
      within(section).getAllByTitle(protectedRuntimeContextUse.use_profile_reference)[0],
    ).toBeVisible();
    expect(
      within(section).getByTitle(protectedRuntimeContextUse.integrity_reference),
    ).toBeVisible();
    expect(section).toHaveTextContent(/Historical protected-side outcome evidence only/i);
    expect(section).not.toHaveTextContent(/authorized browser session|MFA|second session/i);
    expect(section).not.toHaveTextContent(
      /context-handle\.hidden|slot\.hidden|locator\.hidden|receipt\.hidden|nonce\.hidden|credential\.hidden|secret\.hidden/i,
    );
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    expect(within(section).queryByRole("textbox")).toBeNull();
    expect(within(section).queryByRole("combobox")).toBeNull();
    expect(within(section).queryByRole("checkbox")).toBeNull();
    expect(records).not.toHaveTextContent(protectedRuntimeContextUse.use_id);
  });

  it("shows loading, empty, forbidden and unavailable protected runtime-context use states", async () => {
    mockReadResponses({
      pendingProtectedRuntimeContextUseResponse: new Promise<Response>(() => {}),
    });
    const loadingView = renderWorkspace();
    let section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    ...
    expect(
      within(section).getByText("Loading protected runtime-context use evidence..."),
    ).toBeVisible();
    expect(within(section).queryByRole("button")).toBeNull();

    loadingView.unmount();
    mockReadResponses({ protectedRuntimeContextUses: [] });
    const emptyView = renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText(
        "No protected runtime-context uses are recorded in this scope.",
      ),
    ).toBeVisible();

    emptyView.unmount();
    mockReadResponses({ protectedRuntimeContextUseStatus: 403 });
    const forbiddenView = renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Runtime-context use evidence permission is missing"),
    ).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();

    forbiddenView.unmount();
    mockReadResponses({ protectedRuntimeContextUseStatus: 503 });
    renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    })).closest("section") as HTMLElement;
    expect(await within(section).findByText("Runtime-context uses are unavailable")).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    expect(within(section).queryByRole("button")).toBeNull();
  });
  ...
  it.each([
    [
      "an extra context handle",
      { ...protectedRuntimeContextUse, context_handle: "context-handle.hidden" },
    ],
    ["a secret field", { ...protectedRuntimeContextUse, secret: "secret.hidden" }],
    [
      "runtime-use authority",
      {
        ...protectedRuntimeContextUse,
        authority: { ...protectedRuntimeContextUse.authority, runtime_use_authorized: true },
      },
    ],
    [
      "a success result without performed use",
      { ...protectedRuntimeContextUse, context_use_performed: false },
    ],
    [
      "an uncertain result claiming performed use",
      {
        ...protectedRuntimeContextUse,
        result_state: "context_use_outcome_uncertain",
        context_use_performed: true,
    ...
    [
      "a recorded uncertainty without recorded completion time",
      {
        ...protectedRuntimeContextUse,
        result_state: "context_use_outcome_uncertain",
        completed_at: null,
    ...
    [
      "a claim-only uncertainty with a completion time",
      {
        ...protectedRuntimeContextUse,
        attempt_state: "started",
        result_state: "context_use_outcome_uncertain",
  ...
  ])("fails closed for protected runtime-context use with %s", async (_case, unsafe) => {
    mockReadResponses({ protectedRuntimeContextUses: [unsafe] });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    })).closest("section") as HTMLElement;
    expect(await within(section).findByText("Runtime-context uses are unavailable")).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    expect(section).not.toHaveTextContent(/context-handle\.hidden|secret\.hidden/i);
  });

  it("uses only the existing username/password session for protected runtime-context use reads", async () => {
    mockReadResponses({ protectedRuntimeContextUseStatus: 401 });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context uses",
    })).closest("section") as HTMLElement;
  ...
  it("renders protected runtime-readiness authorizations as minimized read-only evidence", async () => {
    expect(Object.keys(protectedRuntimeReadinessAuthorization).sort()).toEqual(
      [
        "authorization_lease_id",
        "state",
        "effective_state",
    ...
    expect(Object.keys(protectedRuntimeReadinessAuthorization.authority)).toHaveLength(28);
    expect(
      Object.entries(protectedRuntimeReadinessAuthorization.authority).every(([name, granted]) =>
        name === "protected_runtime_readiness_authority_granted"
          ? granted === true
          : granted === false,
      ),
    ).toBe(true);
    const expiredAuthorization: WorkflowProtectedRuntimeReadinessAuthorization = {
      ...protectedRuntimeReadinessAuthorization,
      authorization_lease_id:
        "workflow-protected-runtime-readiness-lease.abcdef1234567890abcdef12",
      effective_state: "expired",
      issued_at: "2026-08-14T10:08:30Z",
      valid_until: "2026-08-14T10:08:30.750Z",
      effective_until: "2026-08-14T10:08:31Z",
      ...
      integrity_reference:
        "integrity.workflow-protected-runtime-readiness-authorization.abcdef1234567890",
    };
    mockReadResponses({
      protectedRuntimeReadinessAuthorizations: [
        protectedRuntimeReadinessAuthorization,
        expiredAuthorization,
      ],
    });
    ...
    const startSection = (await screen.findByRole("heading", {
      name: "Protected runtime starts",
    })).closest("section") as HTMLElement;
    const section = (await screen.findByRole("heading", {
    ...
    expect(
      startSection.compareDocumentPosition(section) & Node.DOCUMENT_POSITION_FOLLOWING,
    ).toBeTruthy();
    expect(
      vi.mocked(fetch).mock.calls.some(([request]) => {
        const requestedUrl = request instanceof Request ? request.url : request.toString();
    ...
    expect(records).toHaveTextContent(/Consumer contract/i);
    expect(records).toHaveTextContent(/Issued.*valid until.*effective until/i);
    expect(records).toHaveTextContent(/Readiness profile/i);
    expect(records).toHaveTextContent(
      /Dedicated future readiness-request lease active for one request/i,
    );
    expect(records).toHaveTextContent(/Dedicated future readiness-request lease inactive/i);
    expect(records).toHaveTextContent(
      /Existing authority protected runtime start false.*protected runtime-context use false.*runtime use false.*runtime start false.*runtime resume false.*connector activity false.*protected runtime-context injection false.*protected resident-context access false.*target-context capsule opening false.*target-context capsule handoff false.*endpoint resolution false.*route selection false.*route binding false.*credential selection false.*credential assignment binding false.*credential access false.*credential brokerage false.*credential resolution false.*protected artifact access false.*credential delivery false.*network access false.*readiness probe false.*publication false.*delivery false.*dispatch false.*execution false.*infrastructure mutation false/i,
    );
    expect(
      within(section).getAllByTitle(
        protectedRuntimeReadinessAuthorization.readiness_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getByTitle(protectedRuntimeReadinessAuthorization.integrity_reference),
    ).toBeVisible();
    expect(section).toHaveTextContent(/only one future protected runtime-readiness request/i);
    expect(section).toHaveTextContent(/does not authorize a probe, retry/i);
    expect(section).not.toHaveTextContent(/authorized browser session|MFA|second session/i);
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    expect(within(section).queryByRole("textbox")).toBeNull();
  ...
  it("shows loading, empty, unauthorized, forbidden and unavailable runtime-readiness authorization states", async () => {
    mockReadResponses({
      pendingProtectedRuntimeReadinessAuthorizationResponse: new Promise<Response>(() => {}),
    });
    const loadingView = renderWorkspace();
    let section = (await screen.findByRole("heading", {
      name: "Protected runtime-readiness authorizations",
    ...
    expect(
      within(section).getByText("Loading protected runtime-readiness authorizations..."),
    ).toBeVisible();

    loadingView.unmount();
    mockReadResponses({ protectedRuntimeReadinessAuthorizations: [] });
    const emptyView = renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-readiness authorizations",
    })).closest("section") as HTMLElement;
    ...
    emptyView.unmount();
    mockReadResponses({ protectedRuntimeReadinessAuthorizationStatus: 401 });
    const unauthorizedView = renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-readiness authorizations",
    })).closest("section") as HTMLElement;
    ...
    unauthorizedView.unmount();
    mockReadResponses({ protectedRuntimeReadinessAuthorizationStatus: 403 });
    const forbiddenView = renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-readiness authorizations",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Runtime-readiness authorization permission is missing"),
    ).toBeVisible();

    forbiddenView.unmount();
    mockReadResponses({ protectedRuntimeReadinessAuthorizationStatus: 503 });
    renderWorkspace();
    section = (await screen.findByRole("heading", {
      name: "Protected runtime-readiness authorizations",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Runtime-readiness authorizations are unavailable"),
    ).toBeVisible();
    expect(section).toHaveTextContent(/repository is unavailable or failed closed/i);
    expect(within(section).queryByRole("list")).toBeNull();
    expect(within(section).queryByRole("button")).toBeNull();
  ...
  it.each([
    [
      "an extra runtime locator",
      { ...protectedRuntimeReadinessAuthorization, runtime_locator: "runtime.hidden" },
    ],
    [
      "readiness-probe authority",
      {
        ...protectedRuntimeReadinessAuthorization,
        authority: {
          ...protectedRuntimeReadinessAuthorization.authority,
          readiness_probe_authorized: true,
        },
      },
    ],
    [
    ...
    [
      "a mismatched effective state",
      { ...protectedRuntimeReadinessAuthorization, effective_state: "expired" },
    ],
    [
      "an overlong lease",
  ...
  it("renders protected runtime-context injection consumptions as minimized read-only evidence", async () => {
    ...
    const pendingConsumption: WorkflowProtectedRuntimeContextInjectionConsumption = {
      ...protectedRuntimeContextInjectionConsumption,
      injection_id:
        "workflow-protected-runtime-context-injection-consumption.abcdef1234567890abcdef12",
      attempt_state: "started",
      result_state: "injection_pending",
      completed_at: null,
    };
    const uncertainConsumption: WorkflowProtectedRuntimeContextInjectionConsumption = {
      ...pendingConsumption,
      injection_id:
        "workflow-protected-runtime-context-injection-consumption.0123456789abcdef01234567",
      result_state: "injection_outcome_uncertain",
    };
    mockReadResponses({
      protectedRuntimeContextInjectionConsumptions: [
        protectedRuntimeContextInjectionConsumption,
        pendingConsumption,
        uncertainConsumption,
      ],
    });
    renderWorkspace();

    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context injection consumptions",
    })).closest("section") as HTMLElement;
    const records = await within(section).findByRole("list", {
      name: "Protected runtime-context injection consumptions",
    });
    ...
    expect(records).toHaveTextContent("injected into protected runtime slot");
    expect(records).toHaveTextContent("injection pending");
    expect(records).toHaveTextContent("injection outcome uncertain");
    expect(records).toHaveTextContent("completion not recorded");
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextInjectionConsumption.injector_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextInjectionConsumption.runtime_slot_profile_reference,
      )[0],
    ).toBeVisible();
    expect(
      within(section).getAllByTitle(
        protectedRuntimeContextInjectionConsumption.integrity_reference,
      )[0],
    ).toBeVisible();
    expect(section).toHaveTextContent(/Historical metadata only/i);
    expect(section).toHaveTextContent(/does not grant runtime use, network, connector/i);
    expect(within(section).queryByRole("button")).toBeNull();
    expect(within(section).queryByRole("link")).toBeNull();
    expect(within(section).queryByRole("textbox")).toBeNull();
    expect(within(section).queryByRole("combobox")).toBeNull();
    ...
    expect(section).not.toHaveTextContent(/authorized browser session|MFA/i);
    expect(section).not.toHaveTextContent(
      /runtime-handle\.hidden|slot-locator\.hidden|claim\.hidden|receipt\.hidden|nonce\.hidden|idempotency\.hidden|credential\.hidden/i,
    );
  });

  it.each([
    [
      "an extra protected handle field",
      {
        ...protectedRuntimeContextInjectionConsumption,
        runtime_handle_id: "runtime-handle.hidden",
      },
    ...
    [
      "a terminal result without completion",
      {
        ...protectedRuntimeContextInjectionConsumption,
        completed_at: null,
      },
    ...
    [
      "an untrusted injector profile reference",
      {
        ...protectedRuntimeContextInjectionConsumption,
        injector_profile_reference: "integrity.untrusted-injector.1234567890abcdef",
      },
    ],
  ])("fails closed for protected runtime-context injection consumption with %s", async (_case, unsafe) => {
    mockReadResponses({ protectedRuntimeContextInjectionConsumptions: [unsafe] });
    renderWorkspace();
    const section = (await screen.findByRole("heading", {
      name: "Protected runtime-context injection consumptions",
    })).closest("section") as HTMLElement;
    expect(
      await within(section).findByText("Runtime-context injection consumptions are unavailable"),
    ).toBeVisible();
    expect(within(section).queryByRole("list")).toBeNull();
    expect(section).not.toHaveTextContent("runtime-handle.hidden");
  });

  it("uses the existing username/password session for injection consumption reads", async () => {
    mockReadResponses({ protectedRuntimeContextInjectionConsumptionStatus: 401 });
    renderWorkspace();
