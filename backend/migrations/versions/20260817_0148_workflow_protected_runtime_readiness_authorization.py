...
def upgrade() -> None:
    op.create_unique_constraint(
        "uq_wf_rtstart_cons_result_ready_outcome",
        START_RESULT_TABLE,
        [
            "result_id",
            "canonical_digest",
    ...
    op.create_unique_constraint(
        "uq_wf_rtstart_coord_ready_source",
...
def downgrade() -> None:
    ...
    op.drop_constraint("uq_wf_rtstart_coord_ready_source", START_COORDINATION_TABLE, type_="unique")
    op.drop_constraint(
        "uq_wf_rtstart_cons_result_ready_outcome", START_RESULT_TABLE, type_="unique"
    )
