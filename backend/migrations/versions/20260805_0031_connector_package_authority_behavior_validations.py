"""Add immutable connector package authority behavior validations.
...
def upgrade() -> None:
    table = "connector_package_authority_behavior_validations"
    op.create_table(
        table,
        ...
        sa.Column(
            "source_schema_semantics_validation_digest", sa.String(length=64), nullable=False
        ),
        ...
        sa.Column("capability_set_digest", sa.String(length=64), nullable=False),
        sa.Column("findings", postgresql.JSONB(), nullable=False),
        sa.Column("finding_set_digest", sa.String(length=64), nullable=False),
        sa.Column("behavior_validation_digest", sa.String(length=64), nullable=False),
