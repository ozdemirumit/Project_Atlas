"""Add immutable connector package license analyses.
...
def upgrade() -> None:
    table = "connector_package_license_analyses"
    op.create_table(
        table,
        ...
        sa.Column("source_malware_analysis_id", sa.String(length=128), nullable=False),
        sa.Column("source_malware_analysis_digest", sa.String(length=64), nullable=False),
        sa.Column("source_vulnerability_analysis_id", sa.String(length=128), nullable=False),
        sa.Column("source_vulnerability_analysis_digest", sa.String(length=64), nullable=False),
        sa.Column("source_static_dependency_analysis_id", sa.String(length=128), nullable=False),
        sa.Column("source_static_dependency_analysis_digest", sa.String(length=64), nullable=False),
        sa.Column("source_authority_behavior_validation_id", sa.String(length=128), nullable=False),
        sa.Column("source_schema_semantics_validation_id", sa.String(length=128), nullable=False),
        ...
        sa.Column("source_schema_validated_by", sa.String(length=128), nullable=False),
        sa.Column("source_authority_validated_by", sa.String(length=128), nullable=False),
        sa.Column("source_static_analyzed_by", sa.String(length=128), nullable=False),
        sa.Column("source_vulnerability_analyzed_by", sa.String(length=128), nullable=False),
        sa.Column("source_malware_analyzed_by", sa.String(length=128), nullable=False),
        ...
        sa.Column("analyzed_by", sa.String(length=128), nullable=False),
        sa.Column("analysis_profile", sa.String(length=128), nullable=False),
        ...
        sa.Column("subject_summary", postgresql.JSONB(), nullable=False),
        ...
        sa.CheckConstraint("version = 1", name="ck_connector_package_license_analyses_version"),
