"""Add immutable connector internal registry publication receipts.
...
def upgrade() -> None:
    table = "connector_registry_publication_receipts"
    op.create_table(
        table,
        sa.Column("receipt_id", sa.String(length=128), nullable=False),
        sa.Column("source_signing_receipt_id", sa.String(length=128), nullable=False),
