"""Add immutable connector package static dependency analyses.
...
def upgrade() -> None:
    table = "connector_package_static_dependency_analyses"
    op.create_table(
        table,
        ...
        sa.Column(
            "source_authority_behavior_validation_digest", sa.String(length=64), nullable=False
        ),
        ...
        sa.Column("source_summary", postgresql.JSONB(), nullable=False),
        sa.Column("dependency_summary", postgresql.JSONB(), nullable=False),
