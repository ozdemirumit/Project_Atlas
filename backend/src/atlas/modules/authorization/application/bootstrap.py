...
WORKFLOW_PROTECTED_RUNTIME_CONTEXT_USE_AUTHORIZATION_READ = (
    "workflow.protected-runtime-context-use-authorizations.read"
)
WORKFLOW_PROTECTED_RUNTIME_START_AUTHORIZATION_READ = (
    "workflow.protected-runtime-start-authorizations.read"
)
WORKFLOW_PROTECTED_RUNTIME_READINESS_AUTHORIZATION_READ = (
    "workflow.protected-runtime-readiness-authorizations.read"
)
...
def workflow_protected_runtime_context_injection_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id=("resource.workflow.protected-runtime-context-injection-authorizations"),
        capability_class=CapabilityClass.C1_READ_ONLY,
    )
...
def workflow_protected_runtime_context_use_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-context-use-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_start_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-start-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_readiness_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-readiness-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_readiness_consumption_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-readiness-consumptions",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_process_creation_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-process-creation-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_process_scheduling_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-process-scheduling-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_process_resume_authorization_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-process-resume-authorizations",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )
...
def workflow_protected_runtime_process_scheduling_consumption_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-process-scheduling-consumptions",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )
...
def workflow_protected_runtime_start_consumption_scope(
    ...
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id="resource.workflow.protected-runtime-start-consumptions",
        capability_class=CapabilityClass.C1_READ_ONLY,
    )


def workflow_protected_runtime_context_use_authorization_consumption_scope(
    organization_id: str,
    environment: str,
) -> ResourceScope:
    return ResourceScope(
        ...
        site_id="site.local",
        domain_id="domain.workflow",
        resource_id=("resource.workflow.protected-runtime-context-use-authorization-consumptions"),
        capability_class=CapabilityClass.C1_READ_ONLY,
    )
...
def build_development_authorization_service(
    ...
    permissions = (
        ...
        *operation_resource_permission_definitions(),
        ...
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_CONTEXT_USE_AUTHORIZATION_READ,
            description=("Read minimized immutable protected runtime-context use authorizations."),
        ),
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_START_AUTHORIZATION_READ,
            description="Read minimized immutable protected runtime-start authorizations.",
        ),
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_READINESS_AUTHORIZATION_READ,
            description="Read minimized immutable protected runtime-readiness authorizations.",
        ),
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_READINESS_CONSUMPTION_READ,
            description="Read minimized immutable protected runtime-readiness outcomes.",
        ),
        PermissionDefinition(
        ...
        PermissionDefinition(
            ...
            description=(
                "Read minimized immutable protected runtime process-scheduling authorizations."
            ),
        ),
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_PROCESS_RESUME_AUTHORIZATION_READ,
            description=(
                "Read minimized immutable protected runtime process-resume authorizations."
            ),
        ),
        PermissionDefinition(
        ...
        PermissionDefinition(
            ...
            description=("Read minimized immutable protected runtime process-scheduling outcomes."),
        ),
        PermissionDefinition(
            permission_id=WORKFLOW_PROTECTED_RUNTIME_START_CONSUMPTION_READ,
            description="Read minimized immutable protected runtime-start outcomes.",
        ),
        PermissionDefinition(
            permission_id=(WORKFLOW_PROTECTED_RUNTIME_CONTEXT_USE_AUTHORIZATION_CONSUMPTION_READ),
            description=(
    ...
    if (
        ...
        assignments = (
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.ai-protected-recommendation-presentation-create"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.ai-protected-recommendation-presentation-read"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-promotion-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-promotion-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_promotion_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-readiness-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-readiness-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_readiness_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-review-request-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-review-request-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_review_request_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-reviewer-assignment-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-reviewer-assignment-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_reviewer_assignment_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-protected-inspection-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-protected-inspection-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_protected_inspection_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-protected-content-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-protected-content-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_protected_content_scope(
            ...
            RoleAssignment(
                assignment_id=("assignment.development.recommendation-human-review-finding-create"),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id=("assignment.development.recommendation-human-review-finding-read"),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_human_review_finding_scope(
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-finding-presentation-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-finding-presentation-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_finding_presentation_scope(
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.recommendation-track-review-decision-create"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id=("assignment.development.recommendation-track-review-decision-read"),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_track_review_decision_scope(
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.recommendation-correction-resubmission-create"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.recommendation-correction-resubmission-read"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-final-disposition-create",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id="assignment.development.recommendation-final-disposition-read",
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
                scope=recommendation_final_disposition_scope(
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development.workflow-protected-runtime-readiness-authorizations"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
            ...
            RoleAssignment(
                assignment_id=(
                    "assignment.development."
                    "workflow-protected-runtime-process-scheduling-authorizations"
                ),
                version=1,
                subject_id=settings.development_subject_id,
                role_id=DEVELOPMENT_ROLE_ID,
