...
class AuthorizationProtectedRecommendationAdjudicationPermissionAuthorizer:
    ...
    async def authorize(
        ...
        *,
        ...
        adjudication_scope = ai_protected_recommendation_adjudication_scope(
        ...
        requests = (
            self._request(
                actor,
                AI_PROTECTED_RECOMMENDATION_ADJUDICATION_CREATE,
                "resource.ai.protected-recommendation-adjudication",
                adjudication_scope,
                correlation_id,
                now,
            ),
