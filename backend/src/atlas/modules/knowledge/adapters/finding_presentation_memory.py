...
class InMemoryOperationalKnowledgeFindingPresentationPolicySource:
    def __init__(
        self, policies: tuple[OperationalKnowledgeFindingPresentationPolicySnapshot, ...]
    ) -> None:
...
class InMemoryOperationalKnowledgeFindingPresentationRepository:
    def __init__(self) -> None:
        self._claims_by_finding: dict[str, OperationalKnowledgeFindingPresentationClaim] = {}
        self._claims_by_idempotency: dict[
            tuple[str, str], OperationalKnowledgeFindingPresentationClaim
        ] = {}
        self._records: dict[str, OperationalKnowledgeFindingPresentationRecord] = {}
