...
class WorkflowProtectedTransportTargetContextCapsuleOpeningAuthorizationLeaseModel(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "consumer_receipt_id",
            "receipt_digest",
            name="uq_wf_tctx_open_auth_consume_lineage",
        ),
        ForeignKeyConstraint(
            [
                "handoff_id",
...
class WorkflowProtectedTransportTargetContextCapsuleOpeningConsumptionClaimModel(Base):
    __tablename__ = "workflow_event_tctx_capsule_opening_consumption_claims"
    __table_args__ = (
        UniqueConstraint("authorization_lease_id", name="uq_wf_tctx_open_consume_lease"),
        UniqueConstraint("handoff_id", name="uq_wf_tctx_open_consume_handoff"),
        UniqueConstraint("consumer_receipt_id", name="uq_wf_tctx_open_consume_receipt"),
        UniqueConstraint("sealed_capsule_id", name="uq_wf_tctx_open_consume_capsule"),
        UniqueConstraint("opening_id", name="uq_wf_tctx_open_consume_opening"),
        UniqueConstraint("attempt_id", name="uq_wf_tctx_open_consume_attempt"),
        UniqueConstraint(
            "idempotency_scope_id",
            "idempotency_key",
            name="uq_wf_tctx_open_consume_scope_idem",
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_tctx_open_consume_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "opening_id",
            "attempt_id",
            name="uq_wf_tctx_caps_open_claim_access_auth_lineage",
        ),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_tctx_capsule_opening_authorization_leases.authorization_lease_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.canonical_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.handoff_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.handoff_result_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.attempt_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.attempt_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.consumption_claim_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.consumption_claim_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.consumer_binding_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.consumer_binding_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.sealed_capsule_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.sealed_capsule_digest",
                "workflow_event_tctx_capsule_opening_authorization_leases.consumer_receipt_id",
                "workflow_event_tctx_capsule_opening_authorization_leases.receipt_digest",
            ],
        ...
        CheckConstraint(
            ...
            name="ck_wf_tctx_open_consume_contract",
        ),
        CheckConstraint(
            "irreversible_consumption_acknowledged "
            "AND uncertain_outcome_requires_new_authorization_acknowledged",
        ...
        CheckConstraint(
            ...
            name="ck_wf_tctx_open_consume_authority",
        ),
        Index(
    ...
    handoff_id: Mapped[str] = mapped_column(String(128), nullable=False)
    handoff_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    handoff_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    handoff_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    handoff_consumption_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    handoff_consumption_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    consumer_binding_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_binding_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    sealed_capsule_id: Mapped[str] = mapped_column(String(128), nullable=False)
    sealed_capsule_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    consumer_receipt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_receipt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    sealed_capsule_is_bearer_capability: Mapped[bool] = mapped_column(Boolean, nullable=False)
    consumer_receipt_is_bearer_capability: Mapped[bool] = mapped_column(Boolean, nullable=False)
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
...
class WorkflowProtectedTransportTargetContextCapsuleOpeningAttemptModel(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "consumption_claim_id",
            "consumption_claim_digest",
            name="uq_wf_tctx_caps_open_attempt_access_auth_lineage",
        ),
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_tctx_capsule_opening_consumption_claims.claim_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.canonical_digest",
                "workflow_event_tctx_capsule_opening_consumption_claims.opening_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.attempt_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.authorization_lease_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.authorization_lease_digest",
                "workflow_event_tctx_capsule_opening_consumption_claims.consumer_binding_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.consumer_binding_digest",
                "workflow_event_tctx_capsule_opening_consumption_claims.sealed_capsule_id",
                "workflow_event_tctx_capsule_opening_consumption_claims.sealed_capsule_digest",
    ...
    policy_version: Mapped[str] = mapped_column(String(64), nullable=False)
    policy_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    required_opener_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    required_opener_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    approved_opener_id: Mapped[str] = mapped_column(String(128), nullable=False)
    approved_opener_version: Mapped[str] = mapped_column(String(64), nullable=False)
    destination_boundary_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_deployment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    destination_fencing_token_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    custody_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    trusted_opener_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    custody_attestation_id: Mapped[str] = mapped_column(String(128), nullable=False)
    custody_attestation_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    openability_attestation_id: Mapped[str] = mapped_column(String(128), nullable=False)
    openability_attestation_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    opening_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    lease_valid_until: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    custody_attestation_valid_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    ...
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    custody_attestation_payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    openability_attestation_payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
...
class WorkflowProtectedTransportTargetContextCapsuleOpeningResultModel(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            name="uq_wf_tctx_caps_open_result_access_auth_lineage",
        ),
        ForeignKeyConstraint(
            [
                "attempt_id",
            ...
            [
                "workflow_event_tctx_capsule_opening_attempts.attempt_id",
                "workflow_event_tctx_capsule_opening_attempts.canonical_digest",
                "workflow_event_tctx_capsule_opening_attempts.opening_id",
                "workflow_event_tctx_capsule_opening_attempts.consumption_claim_id",
                "workflow_event_tctx_capsule_opening_attempts.consumption_claim_digest",
                "workflow_event_tctx_capsule_opening_attempts.authorization_lease_id",
                "workflow_event_tctx_capsule_opening_attempts.authorization_lease_digest",
                "workflow_event_tctx_capsule_opening_attempts.consumer_binding_id",
                "workflow_event_tctx_capsule_opening_attempts.consumer_binding_digest",
                "workflow_event_tctx_capsule_opening_attempts.sealed_capsule_id",
                "workflow_event_tctx_capsule_opening_attempts.sealed_capsule_digest",
    ...
    opener_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opener_version: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_receipt_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    state: Mapped[str] = mapped_column(String(64), nullable=False)
    failure_class: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    capsule_opened_in_protected_boundary: Mapped[bool] = mapped_column(Boolean, nullable=False)
    target_context_pair_verified: Mapped[bool] = mapped_column(Boolean, nullable=False)
    outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    protected_source_closed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    source_capsule_zeroized: Mapped[bool] = mapped_column(Boolean, nullable=False)
    ...
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    opening_receipt_payload: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)


class WorkflowProtectedResidentContextAccessAuthorizationLeaseModel(Base):
    __tablename__ = "workflow_event_resident_context_access_auth_leases"
    __table_args__ = (
        UniqueConstraint("opening_id", name="uq_wf_rc_access_auth_lease_result"),
        UniqueConstraint(
            "protected_resident_context_id", name="uq_wf_rc_access_auth_lease_context"
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_rc_access_auth_lease_digest"),
        UniqueConstraint(
        ...
        UniqueConstraint(
            ...
            "protected_resident_context_id",
            "protected_resident_context_digest",
            name="uq_wf_rc_access_auth_consume_lineage",
        ),
        ForeignKeyConstraint(
            [
                "opening_id",
            ...
            [
                "workflow_event_tctx_capsule_opening_results.opening_id",
                "workflow_event_tctx_capsule_opening_results.canonical_digest",
                "workflow_event_tctx_capsule_opening_results.attempt_id",
                "workflow_event_tctx_capsule_opening_results.attempt_digest",
                "workflow_event_tctx_capsule_opening_results.consumption_claim_id",
                "workflow_event_tctx_capsule_opening_results.consumption_claim_digest",
                "workflow_event_tctx_capsule_opening_results.authorization_lease_id",
                "workflow_event_tctx_capsule_opening_results.authorization_lease_digest",
                "workflow_event_tctx_capsule_opening_results.protected_resident_context_id",
                "workflow_event_tctx_capsule_opening_results.protected_resident_context_digest",
                "workflow_event_tctx_capsule_opening_results.opening_receipt_digest",
            ],
        ...
        CheckConstraint(
            ...
            "AND NOT execution_authority_granted "
            "AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rc_access_auth_lease_authority",
        ),
        Index(
    ...
    access_authorization_lease_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    ...
    opening_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_consumption_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_consumption_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_receipt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_result_state: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_completed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    opening_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    protected_resident_context_id: Mapped[str] = mapped_column(String(128), nullable=False)
    protected_resident_context_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    protected_resident_context_created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    protected_resident_context_usable_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    ...
    lifecycle_attestor_version: Mapped[str] = mapped_column(String(64), nullable=False)
    lifecycle_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    lifecycle_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    lifecycle_attestation_valid_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    resident_context_present: Mapped[bool] = mapped_column(Boolean, nullable=False)
    resident_context_unexpired: Mapped[bool] = mapped_column(Boolean, nullable=False)
    resident_context_unrevoked: Mapped[bool] = mapped_column(Boolean, nullable=False)
    resident_context_undestroyed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    resident_context_unconsumed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    resident_context_handle_outstanding: Mapped[bool] = mapped_column(Boolean, nullable=False)
    protected_resident_context_is_bearer_capability: Mapped[bool] = mapped_column(
        Boolean, nullable=False
    )
    capsule_opened_in_protected_boundary: Mapped[bool] = mapped_column(Boolean, nullable=False)
    target_context_pair_verified: Mapped[bool] = mapped_column(Boolean, nullable=False)
    opening_outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    protected_source_closed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    source_capsule_zeroized: Mapped[bool] = mapped_column(Boolean, nullable=False)
    issued_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    valid_until: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
...
class WorkflowProtectedResidentContextAccessAuthorizationClaimModel(Base):
    __tablename__ = "workflow_event_resident_context_access_auth_claims"
    __table_args__ = (
        ForeignKeyConstraint(
            [
                "access_authorization_lease_id",
            ...
            [
                "workflow_event_resident_context_access_auth_leases.access_authorization_lease_id",
                "workflow_event_resident_context_access_auth_leases.opening_id",
                "workflow_event_resident_context_access_auth_leases.protected_resident_context_id",
            ],
        ...
        UniqueConstraint("canonical_digest", name="uq_wf_rc_access_auth_claim_digest"),
        CheckConstraint(
            "consumer_subject_id = "
            "'service.workflow-protected-transport-target-context-capsule-consumer' "
            "AND consumer_audience = "
        ...
        CheckConstraint(
            "NOT protected_resident_context_access_authority_granted "
            "AND NOT target_context_capsule_handoff_authority_granted "
            "AND NOT target_context_capsule_opening_authority_granted "
            "AND NOT endpoint_resolution_authority_granted "
            "AND NOT route_selection_authority_granted "
            ...
            "AND NOT execution_authority_granted "
            "AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rc_access_auth_claim_authority",
        ),
    )

    claim_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    access_authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    opening_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    opening_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
...
class WorkflowProtectedResidentContextAccessConsumptionClaimModel(Base):
    __tablename__ = "workflow_event_resident_context_access_consumption_claims"
    __table_args__ = (
        UniqueConstraint("authorization_lease_id", name="uq_wf_rc_access_consume_lease"),
        UniqueConstraint("protected_resident_context_id", name="uq_wf_rc_access_consume_context"),
        UniqueConstraint("access_id", name="uq_wf_rc_access_consume_operation"),
        UniqueConstraint("attempt_id", name="uq_wf_rc_access_consume_attempt"),
        UniqueConstraint(
            "idempotency_scope_id", "idempotency_key", name="uq_wf_rc_access_consume_scope_idem"
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_rc_access_consume_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "access_id",
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_resident_context_access_auth_leases.access_authorization_lease_id",
                "workflow_event_resident_context_access_auth_leases.canonical_digest",
                "workflow_event_resident_context_access_auth_leases.claim_id",
                "workflow_event_resident_context_access_auth_leases.claim_digest",
                "workflow_event_resident_context_access_auth_leases.opening_id",
                "workflow_event_resident_context_access_auth_leases.protected_resident_context_id",
                "workflow_event_resident_context_access_auth_leases.protected_resident_context_digest",
            ],
        ...
        CheckConstraint(
            ...
            "AND NOT target_context_capsule_handoff_authority_granted "
            "AND NOT target_context_capsule_opening_authority_granted "
            "AND NOT endpoint_resolution_authority_granted AND NOT route_selection_authority_granted "
            "AND NOT route_binding_authority_granted AND NOT credential_selection_authority_granted "
            "AND NOT credential_assignment_binding_authority_granted "
            "AND NOT credential_access_authority_granted AND NOT credential_brokerage_authority_granted "
            "AND NOT credential_resolution_authority_granted AND NOT protected_artifact_access_authority_granted "
            "AND NOT credential_delivery_authority_granted AND NOT network_access_authority_granted "
            "AND NOT readiness_probe_authority_granted AND NOT publication_authority_granted "
            "AND NOT delivery_authority_granted AND NOT dispatch_authority_granted "
            "AND NOT execution_authority_granted AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rc_access_consume_authority",
        ),
        Index(
    ...
    claim_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    access_id: Mapped[str] = mapped_column(String(128), nullable=False)
    attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
...
class WorkflowProtectedResidentContextAccessAttemptModel(Base):
    __tablename__ = "workflow_event_resident_context_access_attempts"
    __table_args__ = (
        UniqueConstraint("consumption_claim_id", name="uq_wf_rc_access_attempt_claim"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rc_access_attempt_lease"),
        UniqueConstraint("protected_resident_context_id", name="uq_wf_rc_access_attempt_context"),
        UniqueConstraint("access_id", name="uq_wf_rc_access_attempt_operation"),
        UniqueConstraint("canonical_digest", name="uq_wf_rc_access_attempt_digest"),
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
            "access_id",
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_resident_context_access_consumption_claims.claim_id",
                "workflow_event_resident_context_access_consumption_claims.canonical_digest",
                "workflow_event_resident_context_access_consumption_claims.access_id",
                "workflow_event_resident_context_access_consumption_claims.attempt_id",
                "workflow_event_resident_context_access_consumption_claims.authorization_lease_id",
                "workflow_event_resident_context_access_consumption_claims.authorization_lease_digest",
                "workflow_event_resident_context_access_consumption_claims.protected_resident_context_id",
                "workflow_event_resident_context_access_consumption_claims.protected_resident_context_digest",
            ],
            name="fk_wf_rc_access_attempt_claim_lineage",
        ),
        CheckConstraint("state = 'started'", name="ck_wf_rc_access_attempt_state"),
        CheckConstraint(
            "consumer_subject_id = 'service.workflow-protected-transport-target-context-capsule-consumer' "
            "AND consumer_audience = 'audience.workflow-protected-transport-target-context-capsule-consumer' "
            "AND consumer_contract_id = 'contract.workflow-protected-transport-target-context-capsule-consumer' "
        ...
        CheckConstraint(
            "NOT protected_resident_context_access_authority_granted AND NOT target_context_capsule_handoff_authority_granted "
            "AND NOT target_context_capsule_opening_authority_granted AND NOT endpoint_resolution_authority_granted "
            "AND NOT route_selection_authority_granted AND NOT route_binding_authority_granted "
            "AND NOT credential_selection_authority_granted AND NOT credential_assignment_binding_authority_granted "
            "AND NOT credential_access_authority_granted AND NOT credential_brokerage_authority_granted "
            "AND NOT credential_resolution_authority_granted AND NOT protected_artifact_access_authority_granted "
            "AND NOT credential_delivery_authority_granted AND NOT network_access_authority_granted "
            "AND NOT readiness_probe_authority_granted AND NOT publication_authority_granted "
            "AND NOT delivery_authority_granted AND NOT dispatch_authority_granted "
            "AND NOT execution_authority_granted AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rc_access_attempt_authority",
        ),
        Index(
    ...
    policy_version: Mapped[str] = mapped_column(String(64), nullable=False)
    policy_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    required_accessor_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    required_accessor_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    approved_accessor_id: Mapped[str] = mapped_column(String(128), nullable=False)
    approved_accessor_version: Mapped[str] = mapped_column(String(64), nullable=False)
    destination_boundary_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_deployment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    destination_fencing_token_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_handle_profile_id: Mapped[str] = mapped_column(String(128), nullable=False)
    runtime_handle_profile_version: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_handle_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    lifecycle_attestation_id: Mapped[str] = mapped_column(String(128), nullable=False)
    lifecycle_attestation_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    access_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    authorization_lease_valid_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    protected_resident_context_usable_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
...
class WorkflowProtectedResidentContextAccessResultModel(Base):
    __tablename__ = "workflow_event_resident_context_access_results"
    __table_args__ = (
        UniqueConstraint("attempt_id", name="uq_wf_rc_access_result_attempt"),
        UniqueConstraint("consumption_claim_id", name="uq_wf_rc_access_result_claim"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rc_access_result_lease"),
        UniqueConstraint("protected_resident_context_id", name="uq_wf_rc_access_result_context"),
        UniqueConstraint("access_id", name="uq_wf_rc_access_result_operation"),
        UniqueConstraint("canonical_digest", name="uq_wf_rc_access_result_digest"),
        UniqueConstraint(
            "access_id",
            "canonical_digest",
            "attempt_id",
            ...
            "outcome_known",
            name="uq_wf_rc_access_result_injection_auth_lineage",
        ),
        ForeignKeyConstraint(
            [
                "attempt_id",
            ...
            [
                "workflow_event_resident_context_access_attempts.attempt_id",
                "workflow_event_resident_context_access_attempts.canonical_digest",
                "workflow_event_resident_context_access_attempts.access_id",
                "workflow_event_resident_context_access_attempts.consumption_claim_id",
                "workflow_event_resident_context_access_attempts.consumption_claim_digest",
                "workflow_event_resident_context_access_attempts.authorization_lease_id",
                "workflow_event_resident_context_access_attempts.authorization_lease_digest",
                "workflow_event_resident_context_access_attempts.protected_resident_context_id",
                "workflow_event_resident_context_access_attempts.protected_resident_context_digest",
            ],
        ...
        CheckConstraint(
            ...
            "AND outcome_known AND NOT protected_runtime_handle_is_bearer_capability) OR "
        ...
        CheckConstraint(
            ...
            "AND NOT delivery_authority_granted AND NOT dispatch_authority_granted "
            "AND NOT execution_authority_granted AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rc_access_result_authority",
        ),
        Index(
    ...
    policy_version: Mapped[str] = mapped_column(String(64), nullable=False)
    policy_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    accessor_id: Mapped[str] = mapped_column(String(128), nullable=False)
    accessor_version: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_handle_profile_id: Mapped[str] = mapped_column(String(128), nullable=False)
    runtime_handle_profile_version: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_handle_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    protected_runtime_handle_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    protected_runtime_handle_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    protected_runtime_handle_created_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    protected_runtime_handle_usable_until: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    protected_runtime_handle_is_bearer_capability: Mapped[bool] = mapped_column(
        Boolean, nullable=False
    )
    ...
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    accessor_receipt_payload: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)


class WorkflowProtectedRuntimeContextInjectionDestinationHeadModel(Base):
    __tablename__ = "workflow_protected_runtime_context_injection_destination_heads"
    __table_args__ = (
        UniqueConstraint(
            "destination_boundary_id",
        ...
        CheckConstraint(
            ...
            "AND policy_digest = "
            "'cf8b08ca5eef652623d69dd4521f8e25a7d537dc80a06de40fa7cc4cdc34fbcb' "
            "AND current",
    ...
    destination_deployment_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    destination_boundary_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    destination_fencing_token_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    policy_digest: Mapped[str] = mapped_column(String(64), nullable=False)
...
class WorkflowProtectedRuntimeContextInjectionAuthorizationLeaseModel(Base):
    __tablename__ = "workflow_event_runtime_context_injection_auth_leases"
    __table_args__ = (
        UniqueConstraint("access_result_id", name="uq_wf_rtctx_inj_auth_lease_result"),
        UniqueConstraint("protected_runtime_handle_id", name="uq_wf_rtctx_inj_auth_lease_handle"),
        UniqueConstraint("claim_id", name="uq_wf_rtctx_inj_auth_lease_claim"),
        ...
        UniqueConstraint(
            ...
            "effective_until",
            "protected_runtime_handle_usable_until",
            name="uq_wf_rtctx_inj_auth_consume_lineage",
        ),
        ForeignKeyConstraint(
            [
                "access_result_id",
            ...
            [
                "workflow_event_resident_context_access_results.access_id",
                "workflow_event_resident_context_access_results.canonical_digest",
                "workflow_event_resident_context_access_results.attempt_id",
                "workflow_event_resident_context_access_results.attempt_digest",
                "workflow_event_resident_context_access_results.consumption_claim_id",
                "workflow_event_resident_context_access_results.consumption_claim_digest",
                "workflow_event_resident_context_access_results.authorization_lease_id",
                "workflow_event_resident_context_access_results.authorization_lease_digest",
                "workflow_event_resident_context_access_results.accessor_receipt_digest",
                "workflow_event_resident_context_access_results.protected_runtime_handle_id",
                "workflow_event_resident_context_access_results.protected_runtime_handle_digest",
                "workflow_event_resident_context_access_results.runtime_handle_profile_id",
                "workflow_event_resident_context_access_results.runtime_handle_profile_version",
                "workflow_event_resident_context_access_results.runtime_handle_profile_digest",
                "workflow_event_resident_context_access_results.state",
                "workflow_event_resident_context_access_results.completed_at",
                "workflow_event_resident_context_access_results.recorded_at",
                "workflow_event_resident_context_access_results.access_deadline",
                "workflow_event_resident_context_access_results.protected_runtime_handle_created_at",
                "workflow_event_resident_context_access_results.protected_runtime_handle_usable_until",
                "workflow_event_resident_context_access_results.protected_runtime_handle_is_bearer_capability",
                "workflow_event_resident_context_access_results.protected_resident_context_usable_until",
                "workflow_event_resident_context_access_results.protected_resident_context_consumed",
                "workflow_event_resident_context_access_results.runtime_handle_established_in_protected_boundary",
                "workflow_event_resident_context_access_results.outcome_known",
            ],
            name="fk_wf_rtctx_inj_auth_lease_result",
        ),
        ForeignKeyConstraint(
            ["claim_id", "claim_digest", "authorization_lease_id"],
            [
                "workflow_event_runtime_context_injection_auth_claims.claim_id",
                "workflow_event_runtime_context_injection_auth_claims.canonical_digest",
                "workflow_event_runtime_context_injection_auth_claims.authorization_lease_id",
            ],
            name="fk_wf_rtctx_inj_auth_lease_claim",
            deferrable=True,
            initially="DEFERRED",
        ),
        CheckConstraint(
            ...
            "AND policy_version = '1.0' AND policy_digest = "
            "'cf8b08ca5eef652623d69dd4521f8e25a7d537dc80a06de40fa7cc4cdc34fbcb'",
            name="ck_wf_rtctx_inj_auth_lease_contract",
        ),
        CheckConstraint(
            ...
            "AND runtime_handle_profile_digest = "
            "'1a318541a6303a5caf48131a737b1e79f458c7442498fa8dcc83f7f137e63e8a'",
            name="ck_wf_rtctx_inj_auth_lease_source",
        ),
        CheckConstraint(
            "state = 'authorized_unconsumed' AND single_use "
            "AND NOT renewable AND NOT transferable AND NOT lease_is_bearer_capability",
        ...
        CheckConstraint(
            ...
            "AND NOT execution_authority_granted "
            "AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rtctx_inj_auth_lease_authority",
        ),
        Index(
    ...
    claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    access_result_id: Mapped[str] = mapped_column(String(128), nullable=False)
    access_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    access_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    access_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    access_consumption_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    access_consumption_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    access_authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    access_authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    accessor_receipt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    access_result_state: Mapped[str] = mapped_column(String(64), nullable=False)
    access_completed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    access_result_recorded_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    access_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    protected_runtime_handle_id: Mapped[str] = mapped_column(String(128), nullable=False)
    protected_runtime_handle_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    protected_runtime_handle_created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    protected_runtime_handle_usable_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    protected_runtime_handle_is_bearer_capability: Mapped[bool] = mapped_column(
        Boolean, nullable=False
    ...
    access_outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    destination_boundary_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_deployment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    destination_fencing_token_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    lifecycle_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    injector_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    injector_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    injector_id: Mapped[str] = mapped_column(String(128), nullable=False)
    injector_version: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    pre_attestation_observed_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    runtime_handle_present: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_is_bearer_capability: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_unexpired: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_unrevoked: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_undestroyed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_uninjected: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_unused: Mapped[bool] = mapped_column(Boolean, nullable=False)
    injection_consumption_outstanding: Mapped[bool] = mapped_column(Boolean, nullable=False)
    destination_generation_current: Mapped[bool] = mapped_column(Boolean, nullable=False)
    destination_fence_current: Mapped[bool] = mapped_column(Boolean, nullable=False)
    injector_profile_eligible: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_slot_profile_eligible: Mapped[bool] = mapped_column(Boolean, nullable=False)
    issued_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    valid_until: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    effective_until: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    single_use: Mapped[bool] = mapped_column(Boolean, nullable=False)
...
class WorkflowProtectedRuntimeContextInjectionAuthorizationClaimModel(Base):
    __tablename__ = "workflow_event_runtime_context_injection_auth_claims"
    __table_args__ = (
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtctx_inj_auth_claim_lease"),
        UniqueConstraint("access_result_id", name="uq_wf_rtctx_inj_auth_claim_result"),
        UniqueConstraint("protected_runtime_handle_id", name="uq_wf_rtctx_inj_auth_claim_handle"),
        UniqueConstraint(
            "idempotency_scope_id",
            "idempotency_key",
            name="uq_wf_rtctx_inj_auth_scope_idem",
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_rtctx_inj_auth_claim_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "authorization_lease_id",
        ...
        ForeignKeyConstraint(
            ...
            name="fk_wf_rtctx_inj_auth_claim_result",
        ),
        ForeignKeyConstraint(
            ...
            [
                ...
                "workflow_event_runtime_context_injection_auth_leases.access_result_id",
                "workflow_event_runtime_context_injection_auth_leases.protected_runtime_handle_id",
            ],
        ...
        CheckConstraint(
            ...
            "AND policy_version = '1.0' AND policy_digest = "
            "'cf8b08ca5eef652623d69dd4521f8e25a7d537dc80a06de40fa7cc4cdc34fbcb'",
            name="ck_wf_rtctx_inj_auth_claim_contract",
        ),
        CheckConstraint(
            "access_result_state = 'handle_established_in_protected_boundary' "
            "AND access_completed_at < access_deadline "
            ...
            "AND runtime_handle_profile_digest = "
            "'1a318541a6303a5caf48131a737b1e79f458c7442498fa8dcc83f7f137e63e8a'",
            name="ck_wf_rtctx_inj_auth_claim_source",
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            "NOT protected_runtime_context_injection_authority_granted "
            "AND NOT protected_resident_context_access_authority_granted "
            "AND NOT target_context_capsule_handoff_authority_granted "
            "AND NOT target_context_capsule_opening_authority_granted "
            "AND NOT endpoint_resolution_authority_granted "
            ...
            "AND NOT execution_authority_granted "
            "AND NOT infrastructure_mutation_authority_granted",
            name="ck_wf_rtctx_inj_auth_claim_authority",
        ),
        Index(
...
_WF_RTCTX_INJ_CONSUME_POLICY_DIGEST = (
    "1a8e963fcb95a15bdc2dcfcc0bd613bbfab3f12a23faedcebff777d65bcc24d4"
)
_WF_RTCTX_INJ_CONSUME_CONTRACT = (
    "consumer_subject_id = 'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = 'audience.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_contract_id = 'contract.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_contract_version = '1.0' "
    ...
    "AND policy_version = '1.0' AND policy_digest = "
    f"'{_WF_RTCTX_INJ_CONSUME_POLICY_DIGEST}'"
)
_WF_RTCTX_INJ_ZERO_AUTHORITY = (
    "NOT protected_resident_context_access_authority_granted "
    "AND NOT target_context_capsule_handoff_authority_granted "
    "AND NOT target_context_capsule_opening_authority_granted "
    "AND NOT endpoint_resolution_authority_granted "
...
class _WorkflowProtectedRuntimeContextInjectionZeroAuthorityColumns:
    protected_resident_context_access_authority_granted: Mapped[bool] = mapped_column(
        Boolean, nullable=False
    )
    target_context_capsule_handoff_authority_granted: Mapped[bool] = mapped_column(
...
class WorkflowProtectedRuntimeContextInjectionSlotHeadModel(Base):
    __tablename__ = "workflow_protected_runtime_context_injection_slot_heads"
    __table_args__ = (
        UniqueConstraint(
            "destination_deployment_id",
        ...
        CheckConstraint(
            ...
            "'use_outcome_uncertain', 'context_used_terminal') "
            "AND current",
    ...
    destination_deployment_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    runtime_slot_commitment: Mapped[str] = mapped_column(String(64), primary_key=True)
    destination_boundary_id: Mapped[str] = mapped_column(String(128), nullable=False)
    destination_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    destination_fencing_token_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_slot_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    slot_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    slot_state: Mapped[str] = mapped_column(String(64), nullable=False)
    current: Mapped[bool] = mapped_column(Boolean, nullable=False)
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False, unique=True)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)


class WorkflowProtectedRuntimeContextInjectionConsumptionClaimModel(
    _WorkflowProtectedRuntimeContextInjectionZeroAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_context_injection_consumption_claims"
    __table_args__ = (
        ForeignKeyConstraint(
            [
                "authorization_lease_id",
            ...
            [
                ...
                "workflow_event_runtime_context_injection_auth_leases.claim_id",
                "workflow_event_runtime_context_injection_auth_leases.claim_digest",
                "workflow_event_runtime_context_injection_auth_leases.access_result_id",
                "workflow_event_runtime_context_injection_auth_leases.access_result_digest",
                "workflow_event_runtime_context_injection_auth_leases.protected_runtime_handle_digest",
                "workflow_event_runtime_context_injection_auth_leases.destination_boundary_id",
                "workflow_event_runtime_context_injection_auth_leases.destination_deployment_id",
                "workflow_event_runtime_context_injection_auth_leases.destination_generation",
                "workflow_event_runtime_context_injection_auth_leases.destination_fencing_token_digest",
                "workflow_event_runtime_context_injection_auth_leases.runtime_handle_profile_digest",
                "workflow_event_runtime_context_injection_auth_leases.runtime_slot_profile_digest",
                "workflow_event_runtime_context_injection_auth_leases.valid_until",
                "workflow_event_runtime_context_injection_auth_leases.effective_until",
                "workflow_event_runtime_context_injection_auth_leases.protected_runtime_handle_usable_until",
            ],
            name="fk_wf_rtctx_inj_consume_auth_lease",
            deferrable=True,
            initially="DEFERRED",
        ),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtctx_inj_consume_lease"),
        UniqueConstraint("protected_runtime_handle_digest", name="uq_wf_rtctx_inj_consume_handle"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
        ...
        UniqueConstraint("injection_id", name="uq_wf_rtctx_inj_consume_operation"),
        UniqueConstraint("attempt_id", name="uq_wf_rtctx_inj_consume_attempt"),
        UniqueConstraint(
            "idempotency_scope_id",
            "idempotency_key",
            name="uq_wf_rtctx_inj_consume_scope_idem",
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_rtctx_inj_consume_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
        ...
        CheckConstraint(_WF_RTCTX_INJ_CONSUME_CONTRACT, name="ck_wf_rtctx_inj_consume_contract"),
        CheckConstraint(
            "irreversible_consumption_acknowledged "
            "AND uncertain_outcome_requires_new_authorization_acknowledged",
        ...
        CheckConstraint(_WF_RTCTX_INJ_ZERO_AUTHORITY, name="ck_wf_rtctx_inj_consume_authority"),
        Index(
    ...
    authorization_lease_effective_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    protected_runtime_handle_usable_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    ...
    runtime_slot_pre_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_subject_id: Mapped[str] = mapped_column(String(240), nullable=False)
...
class WorkflowProtectedRuntimeContextInjectionAttemptModel(
    _WorkflowProtectedRuntimeContextInjectionZeroAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_context_injection_attempts"
    __table_args__ = (
        ForeignKeyConstraint(
            [
                "consumption_claim_id",
            ...
            [
                ...
                "workflow_event_runtime_context_injection_consumption_claims.injection_id",
                "workflow_event_runtime_context_injection_consumption_claims.attempt_id",
                "workflow_event_runtime_context_injection_consumption_claims.authorization_lease_id",
                "workflow_event_runtime_context_injection_consumption_claims.authorization_lease_digest",
                "workflow_event_runtime_context_injection_consumption_claims.protected_runtime_handle_digest",
                "workflow_event_runtime_context_injection_consumption_claims.destination_deployment_id",
                "workflow_event_runtime_context_injection_consumption_claims.runtime_slot_commitment",
                "workflow_event_runtime_context_injection_consumption_claims.runtime_slot_pre_generation",
                "workflow_event_runtime_context_injection_consumption_claims.claimed_at",
            ],
            name="fk_wf_rtctx_inj_attempt_claim_lineage",
            deferrable=True,
            initially="DEFERRED",
        ),
        UniqueConstraint("consumption_claim_id", name="uq_wf_rtctx_inj_attempt_claim"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtctx_inj_attempt_lease"),
        UniqueConstraint("protected_runtime_handle_digest", name="uq_wf_rtctx_inj_attempt_handle"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
            "runtime_slot_pre_generation",
        ...
        CheckConstraint(_WF_RTCTX_INJ_CONSUME_CONTRACT, name="ck_wf_rtctx_inj_attempt_contract"),
        CheckConstraint("state = 'started'", name="ck_wf_rtctx_inj_attempt_state"),
        CheckConstraint(
        ...
        CheckConstraint(_WF_RTCTX_INJ_ZERO_AUTHORITY, name="ck_wf_rtctx_inj_attempt_authority"),
        Index(
    ...
    slot_readiness_attestation_id: Mapped[str] = mapped_column(String(128), nullable=False)
    slot_readiness_attestation_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    slot_readiness_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    slot_readiness_attestation_observed_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    slot_readiness_attestation_valid_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    runtime_slot_profile_id: Mapped[str] = mapped_column(String(128), nullable=False)
    runtime_slot_profile_version: Mapped[str] = mapped_column(String(64), nullable=False)
    expected_runtime_slot_post_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    required_injector_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    required_injector_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    approved_injector_id: Mapped[str] = mapped_column(String(128), nullable=False)
    approved_injector_version: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    lifecycle_attestation_payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    slot_readiness_attestation_payload: Mapped[dict[str, Any]] = mapped_column(
        JSONB, nullable=False
    )


class WorkflowProtectedRuntimeContextInjectionResultModel(
    _WorkflowProtectedRuntimeContextInjectionZeroAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_context_injection_results"
    __table_args__ = (
        ForeignKeyConstraint(
            [
                "attempt_id",
            ...
            [
                ...
                "workflow_event_runtime_context_injection_attempts.injection_id",
                "workflow_event_runtime_context_injection_attempts.consumption_claim_id",
                "workflow_event_runtime_context_injection_attempts.consumption_claim_digest",
                "workflow_event_runtime_context_injection_attempts.authorization_lease_id",
                "workflow_event_runtime_context_injection_attempts.authorization_lease_digest",
                "workflow_event_runtime_context_injection_attempts.protected_runtime_handle_digest",
                "workflow_event_runtime_context_injection_attempts.destination_boundary_id",
                "workflow_event_runtime_context_injection_attempts.destination_deployment_id",
                "workflow_event_runtime_context_injection_attempts.destination_generation",
                "workflow_event_runtime_context_injection_attempts.destination_fencing_token_digest",
                "workflow_event_runtime_context_injection_attempts.runtime_slot_commitment",
                "workflow_event_runtime_context_injection_attempts.runtime_slot_pre_generation",
                "workflow_event_runtime_context_injection_attempts.runtime_slot_profile_digest",
                "workflow_event_runtime_context_injection_attempts.started_at",
                "workflow_event_runtime_context_injection_attempts.injection_deadline",
            ],
            name="fk_wf_rtctx_inj_result_attempt_lineage",
            deferrable=True,
            initially="DEFERRED",
        ),
        UniqueConstraint("attempt_id", name="uq_wf_rtctx_inj_result_attempt"),
        UniqueConstraint("consumption_claim_id", name="uq_wf_rtctx_inj_result_claim"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtctx_inj_result_lease"),
        UniqueConstraint("injection_id", name="uq_wf_rtctx_inj_result_operation"),
        UniqueConstraint("protected_runtime_handle_digest", name="uq_wf_rtctx_inj_result_handle"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
            "runtime_slot_pre_generation",
        ...
        CheckConstraint(_WF_RTCTX_INJ_ZERO_AUTHORITY, name="ck_wf_rtctx_inj_result_authority"),
        Index(
    ...
    runtime_slot_pre_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    runtime_slot_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    runtime_slot_post_generation: Mapped[int | None] = mapped_column(Integer, nullable=True)
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_subject_id: Mapped[str] = mapped_column(String(240), nullable=False)
    ...
    approved_injector_version: Mapped[str] = mapped_column(String(64), nullable=False)
    receipt_verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    injector_receipt_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    claimed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    injection_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    protected_runtime_handle_consumed: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
...
class WorkflowProtectedRuntimeContextUseAuthorizationConsumptionClaimModel(
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "use_profile_version",
            "use_profile_digest",
            name="uq_wf_rtctx_use_consume_claim_source",
        ),
        UniqueConstraint(
            "consumption_claim_id",
            "organization_id",
            ...
            "policy_version",
            "policy_digest",
            name="uq_wf_rtctx_use_consume_claim_source_scope",
        ),
        CheckConstraint(
            _WF_RTCTX_USE_CONSUME_CONTRACT,
...
class WorkflowProtectedRuntimeContextUseAuthorizationConsumptionResultModel(
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "authorization_lease_digest",
            "consumed_at",
            name="uq_wf_rtctx_use_consume_result_lineage",
        ),
        CheckConstraint(
            _WF_RTCTX_USE_CONSUME_CONTRACT,
...
_WF_RTCTX_USE_POLICY_DIGEST = "3be4b37122db97ca4288fdc5cc88af15224069e5257e46a8c198d9e0069f298a"
_WF_RTCTX_USE_PROFILE_DIGEST = "833b75839dd35cb6d4f84e64b1d414aef380a081f4a066e391485a047edddd84"
_WF_RTCTX_USE_CONTRACT = (
    "consumer_subject_id = "
    "'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = "
    "'audience.workflow-protected-transport-target-context-capsule-consumer' "
    ...
    "AND policy_version = '1.0' "
    f"AND policy_digest = '{_WF_RTCTX_USE_POLICY_DIGEST}' "
...
_WF_RTCTX_USE_ZERO_AUTHORITY = (
    _WF_RTCTX_USE_ZERO_PRIOR_AUTHORITY + " AND NOT protected_runtime_context_use_authority_granted"
)
_WF_RTCTX_USE_SOURCE_NAMES = (
...
class _WorkflowProtectedRuntimeContextUseIdentityColumns:
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_subject_id: Mapped[str] = mapped_column(String(240), nullable=False)
...
class _WorkflowProtectedRuntimeContextUseSourceColumns:
    authorization_consumption_result_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_consumption_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    authorization_consumption_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_consumption_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_consumption_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    injection_result_id: Mapped[str] = mapped_column(String(128), nullable=False)
    injection_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    use_profile_version: Mapped[str] = mapped_column(String(64), nullable=False)
    use_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    authorization_consumed_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )


def _workflow_protected_runtime_context_use_source_constraints() -> tuple[
    ForeignKeyConstraint, ...
]:
    return (
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_context_use_auth_consumption_results.result_id",
                "workflow_event_runtime_context_use_auth_consumption_results.canonical_digest",
                "workflow_event_runtime_context_use_auth_consumption_results.consumption_id",
                "workflow_event_runtime_context_use_auth_consumption_results.consumption_claim_id",
                "workflow_event_runtime_context_use_auth_consumption_results.consumption_claim_digest",
                "workflow_event_runtime_context_use_auth_consumption_results.authorization_lease_id",
                "workflow_event_runtime_context_use_auth_consumption_results.authorization_lease_digest",
                "workflow_event_runtime_context_use_auth_consumption_results.consumed_at",
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_context_use_auth_consumption_claims.consumption_claim_id",
                "workflow_event_runtime_context_use_auth_consumption_claims.injection_result_id",
                "workflow_event_runtime_context_use_auth_consumption_claims.injection_result_digest",
                "workflow_event_runtime_context_use_auth_consumption_claims.destination_deployment_id",
                "workflow_event_runtime_context_use_auth_consumption_claims.destination_generation",
                "workflow_event_runtime_context_use_auth_consumption_claims.destination_fencing_token_digest",
                "workflow_event_runtime_context_use_auth_consumption_claims.runtime_slot_commitment",
                "workflow_event_runtime_context_use_auth_consumption_claims.runtime_slot_post_generation",
                "workflow_event_runtime_context_use_auth_consumption_claims.injected_context_usable_until",
                "workflow_event_runtime_context_use_auth_consumption_claims.use_profile_id",
                "workflow_event_runtime_context_use_auth_consumption_claims.use_profile_version",
                "workflow_event_runtime_context_use_auth_consumption_claims.use_profile_digest",
            ],
...
class WorkflowProtectedRuntimeContextUseClaimModel(
    _WorkflowProtectedRuntimeContextUseSourceColumns,
    _WorkflowProtectedRuntimeContextUseIdentityColumns,
    _WorkflowProtectedRuntimeContextUseAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_protected_runtime_context_use_claims"
    __table_args__ = (
        *_workflow_protected_runtime_context_use_source_constraints(),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "use_id",
            "authorization_consumption_result_id",
            "authorization_consumption_result_digest",
            name="uq_wf_rtctx_use_claim_start_source",
        ),
        UniqueConstraint(
            "authorization_consumption_result_id", name="uq_wf_rtctx_use_claim_auth_result"
        ),
        UniqueConstraint("injection_result_id", name="uq_wf_rtctx_use_claim_injection_result"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
            "runtime_slot_pre_generation",
        ...
        UniqueConstraint("use_id", name="uq_wf_rtctx_use_claim_use"),
        UniqueConstraint("attempt_id", name="uq_wf_rtctx_use_claim_attempt"),
        UniqueConstraint(
            "organization_id",
            "environment_id",
            "site_id",
        ...
        UniqueConstraint("canonical_digest", name="uq_wf_rtctx_use_claim_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "use_id",
        ...
        UniqueConstraint(
            "claim_id",
            *_WF_RTCTX_USE_SOURCE_NAMES,
            name="uq_wf_rtctx_use_claim_source_line",
        ),
        UniqueConstraint(
            "claim_id",
            *_WF_RTCTX_USE_IDENTITY_NAMES,
            name="uq_wf_rtctx_use_claim_identity_line",
        ),
        CheckConstraint(_WF_RTCTX_USE_CONTRACT, name="ck_wf_rtctx_use_claim_contract"),
        CheckConstraint(
        ...
        CheckConstraint(
            "use_profile_id = 'profile.workflow-protected-runtime-context-use' "
            "AND use_profile_version = '1.0' "
            f"AND use_profile_digest = '{_WF_RTCTX_USE_PROFILE_DIGEST}'",
        ...
        CheckConstraint(
            ...
            "AND " + _WF_RTCTX_USE_ZERO_AUTHORITY,
    ...
    claim_id: Mapped[str] = mapped_column(String(128), primary_key=True)
    use_id: Mapped[str] = mapped_column(String(128), nullable=False)
    attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    irreversible_use_acknowledged: Mapped[bool] = mapped_column(Boolean, nullable=False)
    uncertainty_no_retry_acknowledged: Mapped[bool] = mapped_column(Boolean, nullable=False)
    request_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    idempotency_scope_id: Mapped[str] = mapped_column(String(64), nullable=False)
    idempotency_key: Mapped[str] = mapped_column(String(128), nullable=False)
    idempotency_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    use_authorization_audit_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    claimed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    use_authorization_audit_payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)


class WorkflowProtectedRuntimeContextUseAttemptModel(
    _WorkflowProtectedRuntimeContextUseSourceColumns,
    _WorkflowProtectedRuntimeContextUseIdentityColumns,
    _WorkflowProtectedRuntimeContextUseAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_protected_runtime_context_use_attempts"
    __table_args__ = (
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
            ...
            "authorization_consumption_result_id",
            "authorization_consumption_result_digest",
            name="uq_wf_rtctx_use_attempt_start_source",
        ),
        ForeignKeyConstraint(
            [
                "claim_id",
            ...
            [
                "workflow_protected_runtime_context_use_claims.claim_id",
                "workflow_protected_runtime_context_use_claims.canonical_digest",
                "workflow_protected_runtime_context_use_claims.use_id",
                "workflow_protected_runtime_context_use_claims.attempt_id",
                "workflow_protected_runtime_context_use_claims.authorization_consumption_result_id",
                "workflow_protected_runtime_context_use_claims.destination_deployment_id",
                "workflow_protected_runtime_context_use_claims.runtime_slot_commitment",
                "workflow_protected_runtime_context_use_claims.runtime_slot_pre_generation",
                "workflow_protected_runtime_context_use_claims.claimed_at",
            ],
            name="fk_wf_rtctx_use_attempt_claim",
        ),
        ForeignKeyConstraint(
            ["claim_id", *_WF_RTCTX_USE_SOURCE_NAMES],
            [
                "workflow_protected_runtime_context_use_claims.claim_id",
                *(
                    f"workflow_protected_runtime_context_use_claims.{name}"
                    for name in _WF_RTCTX_USE_SOURCE_NAMES
                ),
            ],
            name="fk_wf_rtctx_use_attempt_source",
        ),
        ForeignKeyConstraint(
            ["claim_id", *_WF_RTCTX_USE_IDENTITY_NAMES],
            [
                "workflow_protected_runtime_context_use_claims.claim_id",
                *(
                    f"workflow_protected_runtime_context_use_claims.{name}"
                    for name in _WF_RTCTX_USE_IDENTITY_NAMES
                ),
            ],
            name="fk_wf_rtctx_use_attempt_identity",
        ),
        UniqueConstraint("claim_id", name="uq_wf_rtctx_use_attempt_claim"),
        UniqueConstraint(
            "authorization_consumption_result_id", name="uq_wf_rtctx_use_attempt_auth_result"
        ),
        UniqueConstraint("use_id", name="uq_wf_rtctx_use_attempt_use"),
        UniqueConstraint("instruction_digest", name="uq_wf_rtctx_use_attempt_instruction"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtctx_use_attempt_digest"),
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
            "use_id",
        ...
        UniqueConstraint(
            "attempt_id",
            *_WF_RTCTX_USE_SOURCE_NAMES,
            name="uq_wf_rtctx_use_attempt_source_line",
        ),
        UniqueConstraint(
            "attempt_id",
            *_WF_RTCTX_USE_IDENTITY_NAMES,
            name="uq_wf_rtctx_use_attempt_identity_line",
        ),
        ...
        CheckConstraint(
            ...
            "AND eligibility_attestor_id = "
            "'attestor.workflow-protected-runtime-context-use-eligibility' "
            "AND eligibility_attestor_version = '1.0' "
            "AND eligibility_attestation_signing_key_id = "
    ...
    instruction_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    expected_runtime_slot_post_generation: Mapped[int] = mapped_column(Integer, nullable=False)
    expected_use_count_pre: Mapped[int] = mapped_column(Integer, nullable=False)
    expected_use_count_post: Mapped[int] = mapped_column(Integer, nullable=False)
    eligibility_attestor_id: Mapped[str] = mapped_column(String(128), nullable=False)
    eligibility_attestor_version: Mapped[str] = mapped_column(String(64), nullable=False)
    eligibility_attestation_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    eligibility_attestation_id: Mapped[str] = mapped_column(String(128), nullable=False)
    eligibility_attestation_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    eligibility_attestation_observed_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    attestation_valid_until: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    required_executor_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    required_executor_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    approved_executor_id: Mapped[str] = mapped_column(String(128), nullable=False)
    approved_executor_version: Mapped[str] = mapped_column(String(64), nullable=False)
    receipt_verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    claimed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    use_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    state: Mapped[str] = mapped_column(String(64), nullable=False)
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    eligibility_attestation_payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)


class WorkflowProtectedRuntimeContextUseResultModel(
    _WorkflowProtectedRuntimeContextUseSourceColumns,
    _WorkflowProtectedRuntimeContextUseIdentityColumns,
    _WorkflowProtectedRuntimeContextUseAuthorizationAuthorityColumns,
    Base,
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "authorization_consumption_result_id",
            "authorization_consumption_result_digest",
            name="uq_wf_rtctx_use_result_start_source",
        ),
        ForeignKeyConstraint(
            [
                "attempt_id",
            ...
            [
                "workflow_protected_runtime_context_use_attempts.attempt_id",
                "workflow_protected_runtime_context_use_attempts.canonical_digest",
                "workflow_protected_runtime_context_use_attempts.use_id",
                "workflow_protected_runtime_context_use_attempts.claim_id",
                "workflow_protected_runtime_context_use_attempts.claim_digest",
                "workflow_protected_runtime_context_use_attempts.authorization_consumption_result_id",
                "workflow_protected_runtime_context_use_attempts.destination_deployment_id",
                "workflow_protected_runtime_context_use_attempts.runtime_slot_commitment",
                "workflow_protected_runtime_context_use_attempts.runtime_slot_pre_generation",
                "workflow_protected_runtime_context_use_attempts.started_at",
                "workflow_protected_runtime_context_use_attempts.use_deadline",
            ],
            name="fk_wf_rtctx_use_result_attempt",
        ),
        ForeignKeyConstraint(
            ["attempt_id", *_WF_RTCTX_USE_SOURCE_NAMES],
            [
                "workflow_protected_runtime_context_use_attempts.attempt_id",
                *(
                    f"workflow_protected_runtime_context_use_attempts.{name}"
                    for name in _WF_RTCTX_USE_SOURCE_NAMES
                ),
            ],
        ...
        ForeignKeyConstraint(
            ["attempt_id", *_WF_RTCTX_USE_IDENTITY_NAMES],
            [
                "workflow_protected_runtime_context_use_attempts.attempt_id",
                *(
                    f"workflow_protected_runtime_context_use_attempts.{name}"
        ...
        UniqueConstraint("attempt_id", name="uq_wf_rtctx_use_result_attempt"),
        UniqueConstraint("claim_id", name="uq_wf_rtctx_use_result_claim"),
        UniqueConstraint(
        ...
        CheckConstraint(
            ...
            "AND executor_receipt_payload IS NOT NULL "
            "AND runtime_slot_post_generation = runtime_slot_pre_generation + 1 "
            ...
            "AND NOT protected_runtime_context_use_performed "
            "AND NOT context_adopted AND NOT context_terminal_non_reusable "
            "AND transient_material_zeroized) OR "
            "(state = 'context_use_outcome_uncertain' "
            "AND failure_class = 'context_use_outcome_uncertain' "
            "AND NOT outcome_known AND executor_receipt_digest IS NULL "
            "AND executor_receipt_payload IS NULL "
            "AND runtime_slot_post_generation IS NULL "
            "AND use_count_pre = 0 AND use_count_post IS NULL "
            "AND NOT protected_runtime_context_use_performed "
            "AND NOT context_adopted AND NOT context_terminal_non_reusable "
            "AND NOT transient_material_zeroized)",
            name="ck_wf_rtctx_use_result_outcome",
        ),
        CheckConstraint(
            "(NOT outcome_known) OR ("
            "COALESCE((executor_receipt_payload ->> 'canonical_digest') = "
            "executor_receipt_digest, FALSE) "
            "AND COALESCE((executor_receipt_payload ->> 'signing_key_id') = "
            "receipt_verification_signing_key_id, FALSE) "
            "AND COALESCE((executor_receipt_payload ->> 'instruction_digest') = "
            "instruction_digest, FALSE) "
            "AND COALESCE((executor_receipt_payload ->> 'protected_operation_reference') = "
            "protected_operation_reference, FALSE) "
    ...
    protected_operation_reference: Mapped[str] = mapped_column(String(128), nullable=False)
    instruction_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    executor_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    executor_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    receipt_verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    executor_receipt_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    runtime_slot_post_generation: Mapped[int | None] = mapped_column(Integer, nullable=True)
    use_count_pre: Mapped[int] = mapped_column(Integer, nullable=False)
    use_count_post: Mapped[int | None] = mapped_column(Integer, nullable=True)
    claimed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    use_deadline: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    state: Mapped[str] = mapped_column(String(64), nullable=False)
    failure_class: Mapped[str | None] = mapped_column(String(64), nullable=True)
    protected_runtime_context_use_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    context_adopted: Mapped[bool] = mapped_column(Boolean, nullable=False)
    context_terminal_non_reusable: Mapped[bool] = mapped_column(Boolean, nullable=False)
    transient_material_zeroized: Mapped[bool] = mapped_column(Boolean, nullable=False)
    context_disclosed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_handle_disclosed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_slot_locator_disclosed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    derived_capability_created: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_started: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_resumed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    process_created: Mapped[bool] = mapped_column(Boolean, nullable=False)
    prompt_constructed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    model_inference_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    model_output_created: Mapped[bool] = mapped_column(Boolean, nullable=False)
    filesystem_activity_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    provider_activity_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    connector_activity_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    network_activity_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    readiness_probe_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    publication_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
...
_WF_RTSTART_AUTH_POLICY_DIGEST = "8d5db5d3fcfd4ce75a1f4440ec5e543419c6aa95ba96089e315c6367731443e7"
_WF_RTSTART_AUTH_PROFILE_DIGEST = "233c49d3d7cb7d80655d2d2456431f38efecec49ad4c79d2100323754e829995"
_WF_RTSTART_AUTH_CONTRACT = (
    "consumer_subject_id = "
    "'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = "
    "'audience.workflow-protected-transport-target-context-capsule-consumer' "
    ...
    "AND policy_version = '1.0' "
    f"AND policy_digest = '{_WF_RTSTART_AUTH_POLICY_DIGEST}' "
    "AND source_policy_id = 'policy.workflow-protected-runtime-context-use' "
    "AND source_policy_version = '1.0' "
    f"AND source_policy_digest = '{_WF_RTCTX_USE_POLICY_DIGEST}'"
)
_WF_RTSTART_AUTH_SOURCE = (
...
_WF_RTSTART_AUTH_ZERO_EXISTING = (
    _WF_RTCTX_USE_ZERO_AUTHORITY + " AND NOT protected_runtime_start_authority_granted"
)


class _WorkflowProtectedRuntimeStartAuthorizationAuthorityColumns(
    _WorkflowProtectedRuntimeContextUseAuthorizationAuthorityColumns
):
    protected_runtime_start_authority_granted: Mapped[bool] = mapped_column(Boolean, nullable=False)


class _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns:
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_subject_id: Mapped[str] = mapped_column(String(240), nullable=False)
...
class _WorkflowProtectedRuntimeStartAuthorizationSourceColumns:
    ...
    use_id: Mapped[str] = mapped_column(String(128), nullable=False)
    use_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    use_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    use_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    use_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    use_receipt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    authorization_consumption_result_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_consumption_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    use_result_state: Mapped[str] = mapped_column(String(64), nullable=False)
    use_completed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    use_result_recorded_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    use_outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    context_adopted: Mapped[bool] = mapped_column(Boolean, nullable=False)
    protected_runtime_context_use_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    context_terminal_non_reusable: Mapped[bool] = mapped_column(Boolean, nullable=False)
    transient_material_zeroized: Mapped[bool] = mapped_column(Boolean, nullable=False)
...
def _workflow_protected_runtime_start_source_constraints(
    *, prefix: str
) -> tuple[ForeignKeyConstraint, ...]:
    return (
        ForeignKeyConstraint(
            ...
            [
                ...
                "workflow_protected_runtime_context_use_results.use_id",
                "workflow_protected_runtime_context_use_results.attempt_id",
                "workflow_protected_runtime_context_use_results.attempt_digest",
                "workflow_protected_runtime_context_use_results.claim_id",
                "workflow_protected_runtime_context_use_results.claim_digest",
                "workflow_protected_runtime_context_use_results.authorization_consumption_result_id",
        ...
        ForeignKeyConstraint(
            ...
            [
                ...
                "workflow_protected_runtime_context_use_attempts.claim_digest",
                "workflow_protected_runtime_context_use_attempts.authorization_consumption_result_id",
                "workflow_protected_runtime_context_use_attempts.authorization_consumption_result_digest",
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                ...
                "workflow_protected_runtime_context_use_claims.use_id",
                "workflow_protected_runtime_context_use_claims.authorization_consumption_result_id",
                "workflow_protected_runtime_context_use_claims.authorization_consumption_result_digest",
            ],
...
class WorkflowProtectedRuntimeStartCoordinationHeadModel(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            name="fk_wf_rtstart_coord_attempt",
            deferrable=True,
            initially="DEFERRED",
        ),
        ForeignKeyConstraint(
            ...
            name="fk_wf_rtstart_coord_terminal_result",
            deferrable=True,
            initially="DEFERRED",
        ),
    ...
    runtime_start_result_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    runtime_start_result_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    __table_args__ = (
        *_workflow_protected_runtime_start_source_constraints(prefix="lease"),
        ...
        ForeignKeyConstraint(
            ...
            name="fk_wf_rtstart_auth_lease_claim",
            deferrable=True,
            initially="DEFERRED",
        ),
        UniqueConstraint("claim_id", name="uq_wf_rtstart_auth_lease_claim"),
        UniqueConstraint("use_result_id", name="uq_wf_rtstart_auth_lease_use_result"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
            "runtime_slot_post_generation",
        ...
        UniqueConstraint("canonical_digest", name="uq_wf_rtstart_auth_lease_digest"),
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
            name="uq_wf_rtstart_auth_lease_identity",
        ),
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
        ...
        CheckConstraint(_WF_RTSTART_AUTH_CONTRACT, name="ck_wf_rtstart_auth_lease_contract"),
        CheckConstraint(_WF_RTSTART_AUTH_SOURCE, name="ck_wf_rtstart_auth_lease_source"),
        CheckConstraint(
        ...
        CheckConstraint(
            _WF_RTCTX_USE_ZERO_AUTHORITY + " AND protected_runtime_start_authority_granted",
...
class WorkflowProtectedRuntimeStartAuthorizationClaimModel(
    _WorkflowProtectedRuntimeStartAuthorizationSourceColumns,
    _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns,
    _WorkflowProtectedRuntimeStartAuthorizationAuthorityColumns,
    Base,
    ...
    __table_args__ = (
        *_workflow_protected_runtime_start_source_constraints(prefix="claim"),
        ...
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtstart_auth_claim_lease"),
        UniqueConstraint("use_result_id", name="uq_wf_rtstart_auth_claim_use_result"),
        UniqueConstraint(
            "destination_deployment_id",
            "runtime_slot_commitment",
            "runtime_slot_post_generation",
        ...
        UniqueConstraint("canonical_digest", name="uq_wf_rtstart_auth_claim_digest"),
        UniqueConstraint(
            "claim_id",
            "canonical_digest",
            "authorization_lease_id",
...
_WF_RTSTART_CONSUME_POLICY_DIGEST = (
    "75ed8efd455acee45b3df68e65890de39f705ff1849c2eed02818fb8ab39be80"
)
_WF_RTSTART_CONSUME_CONTRACT = (
    "consumer_subject_id = "
    "'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = "
    "'audience.workflow-protected-transport-target-context-capsule-consumer' "
    ...
    "AND policy_version = '1.0' "
    f"AND policy_digest = '{_WF_RTSTART_CONSUME_POLICY_DIGEST}' "
    "AND source_policy_id = 'policy.workflow-protected-runtime-start-authorization' "
    "AND source_policy_version = '1.0' "
    f"AND source_policy_digest = '{_WF_RTSTART_AUTH_POLICY_DIGEST}'"
)
_WF_RTSTART_CONSUME_ZERO_AUTHORITY = _WF_RTSTART_AUTH_ZERO_EXISTING


class _WorkflowProtectedRuntimeStartConsumptionIdentityColumns:
    organization_id: Mapped[str] = mapped_column(String(128), nullable=False)
    environment_id: Mapped[str] = mapped_column(String(128), nullable=False)
    site_id: Mapped[str] = mapped_column(String(128), nullable=False)
    consumer_subject_id: Mapped[str] = mapped_column(String(240), nullable=False)
...
class _WorkflowProtectedRuntimeStartConsumptionSourceColumns:
    authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    authorization_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
...
_WF_RTSTART_CONSUME_SOURCE_NAMES = (
    "authorization_lease_id",
    "authorization_lease_digest",
    "authorization_claim_id",
    "authorization_claim_digest",
...
_WF_RTSTART_CONSUME_IDENTITY_NAMES = (
    "organization_id",
    "environment_id",
    "site_id",
    "consumer_subject_id",
...
def _workflow_protected_runtime_start_consumption_lease_constraint(
    *, prefix: str
) -> ForeignKeyConstraint:
    local = list(_WF_RTSTART_CONSUME_SOURCE_NAMES)
    remote = [
        "authorization_lease_id",
        "canonical_digest",
        "claim_id",
    ...
    return ForeignKeyConstraint(
        local,
        [f"workflow_event_runtime_start_auth_leases.{name}" for name in remote],
        name=f"fk_wf_rtstart_cons_{prefix}_lease",
    )


def _workflow_protected_runtime_start_consumption_coordination_constraint(
    *, prefix: str
) -> ForeignKeyConstraint:
    local = [
        "runtime_envelope_id",
    ...
    return ForeignKeyConstraint(
        local,
        [f"workflow_event_runtime_start_coordination_heads.{name}" for name in remote],
        name=f"fk_wf_rtstart_cons_{prefix}_coord",
    )


class WorkflowProtectedRuntimeStartConsumptionClaimModel(
    _WorkflowProtectedRuntimeStartConsumptionSourceColumns,
    _WorkflowProtectedRuntimeStartConsumptionIdentityColumns,
    _WorkflowProtectedRuntimeStartAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_start_consumption_claims"
    __table_args__ = (
        _workflow_protected_runtime_start_consumption_lease_constraint(prefix="claim"),
        _workflow_protected_runtime_start_consumption_coordination_constraint(prefix="claim"),
        ForeignKeyConstraint(
            ["authorization_claim_id", "authorization_claim_digest", "authorization_lease_id"],
            [
                "workflow_event_runtime_start_auth_claims.claim_id",
        ...
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtstart_cons_claim_lease"),
        UniqueConstraint("consumption_id", name="uq_wf_rtstart_cons_claim_consumption"),
        UniqueConstraint("attempt_id", name="uq_wf_rtstart_cons_claim_attempt"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtstart_cons_claim_digest"),
        UniqueConstraint(
            "organization_id",
            "environment_id",
            "site_id",
        ...
        CheckConstraint(
            ...
            "AND length(idempotency_digest) = 64 "
            "AND length(request_fingerprint) = 64 "
            "AND " + _WF_RTSTART_CONSUME_ZERO_AUTHORITY,
            name="ck_wf_rtstart_cons_claim_semantics",
        ),
        CheckConstraint(
            "jsonb_typeof(payload) = 'object'",
            name="ck_wf_rtstart_cons_claim_payload",
        ),
        Index(
...
class WorkflowProtectedRuntimeStartConsumptionAttemptModel(
    _WorkflowProtectedRuntimeStartConsumptionSourceColumns,
    _WorkflowProtectedRuntimeStartConsumptionIdentityColumns,
    _WorkflowProtectedRuntimeStartAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_start_consumption_attempts"
    __table_args__ = (
        _workflow_protected_runtime_start_consumption_lease_constraint(prefix="attempt"),
        _workflow_protected_runtime_start_consumption_coordination_constraint(prefix="attempt"),
        ForeignKeyConstraint(
            [
                "claim_id",
                "claim_digest",
        ...
        UniqueConstraint("claim_id", name="uq_wf_rtstart_cons_attempt_claim"),
        UniqueConstraint("consumption_id", name="uq_wf_rtstart_cons_attempt_consumption"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtstart_cons_attempt_lease"),
        UniqueConstraint("instruction_digest", name="uq_wf_rtstart_cons_attempt_instruction"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtstart_cons_attempt_digest"),
        UniqueConstraint(
            "claim_id",
            "attempt_id",
            "authorization_lease_id",
        ...
        CheckConstraint(
            ...
            "AND receipt_verification_signing_key_id = "
            "'key.workflow-protected-runtime-start-receipt.v1' "
    ...
    claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    protected_operation_reference: Mapped[str] = mapped_column(String(128), nullable=False)
    expected_start_count_pre: Mapped[int] = mapped_column(Integer, nullable=False)
    expected_start_count_post: Mapped[int] = mapped_column(Integer, nullable=False)
    starter_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    starter_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
    starter_id: Mapped[str] = mapped_column(String(128), nullable=False)
    starter_version: Mapped[str] = mapped_column(String(64), nullable=False)
    receipt_verification_signing_key_id: Mapped[str] = mapped_column(String(128), nullable=False)
    request_nonce_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    claimed_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
...
class WorkflowProtectedRuntimeStartConsumptionResultModel(
    _WorkflowProtectedRuntimeStartConsumptionIdentityColumns,
    _WorkflowProtectedRuntimeStartAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_start_consumption_results"
    __table_args__ = (
        ForeignKeyConstraint(
            [
                "attempt_id",
        ...
        UniqueConstraint("attempt_id", name="uq_wf_rtstart_cons_result_attempt"),
        UniqueConstraint("claim_id", name="uq_wf_rtstart_cons_result_claim"),
        UniqueConstraint("consumption_id", name="uq_wf_rtstart_cons_result_consumption"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtstart_cons_result_digest"),
        UniqueConstraint(
            "result_id",
            "canonical_digest",
            "claim_id",
        ...
        CheckConstraint(
            ...
            "AND starter_receipt_digest IS NOT NULL "
            "AND starter_receipt_payload IS NOT NULL "
        ...
        CheckConstraint(
            "jsonb_typeof(payload) = 'object' "
            "AND (starter_receipt_payload IS NULL "
            "OR jsonb_typeof(starter_receipt_payload) = 'object')",
    ...
    failure_class: Mapped[str | None] = mapped_column(String(64), nullable=True)
    outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_started: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    starter_receipt_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    recorded_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    ...
    __table_args__ = (
        *_workflow_protected_runtime_readiness_source_constraints(prefix="lease"),
        ...
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
            name="uq_wf_rtready_auth_lease_identity",
        ),
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
            "claim_id",
            "claim_digest",
            name="uq_wf_rtproc_src_ready_lease",
        ),
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
            ...
            name="uq_wf_rtready_auth_lease_consume",
        ),
        UniqueConstraint(
            "authorization_lease_id",
            "canonical_digest",
...
_WF_RTREADY_CONSUME_POLICY_DIGEST = (
    "986fdb339467c04ab227dbbb28d73ca566a2888a3234fc1d82a729e104cb2c55"
)
_WF_RTREADY_CONSUME_CONTRACT = (
    "consumer_subject_id = "
    "'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = "
    "'audience.workflow-protected-transport-target-context-capsule-consumer' "
    ...
    "AND policy_version = '1.0' "
    f"AND policy_digest = '{_WF_RTREADY_CONSUME_POLICY_DIGEST}' "
    "AND source_policy_id = 'policy.workflow-protected-runtime-readiness-authorization' "
    "AND source_policy_version = '1.0' "
    f"AND source_policy_digest = '{_WF_RTREADY_AUTH_POLICY_DIGEST}'"
)
_WF_RTREADY_CONSUME_ZERO_AUTHORITY = (
    _WF_RTREADY_AUTH_ZERO_PRIOR + " AND NOT protected_runtime_readiness_authority_granted"
)


class _WorkflowProtectedRuntimeReadinessConsumptionSourceColumns(
    _WorkflowProtectedRuntimeReadinessAuthorizationSourceColumns
):
    authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
...
_WF_RTREADY_CONSUME_LEASE_COLUMNS = (
    "authorization_lease_id",
    "authorization_lease_digest",
    "authorization_claim_id",
    "authorization_claim_digest",
...
def _workflow_protected_runtime_readiness_consumption_lease_constraint(
    *, prefix: str
) -> ForeignKeyConstraint:
    remote = (
        "authorization_lease_id",
        ...
        "claim_id",
        "claim_digest",
        *_WF_RTREADY_CONSUME_LEASE_COLUMNS[4:],
    )
    return ForeignKeyConstraint(
        _WF_RTREADY_CONSUME_LEASE_COLUMNS,
        [f"workflow_event_runtime_readiness_auth_leases.{name}" for name in remote],
...
def _workflow_protected_runtime_readiness_consumption_constraints(
    *, prefix: str
) -> tuple[ForeignKeyConstraint, ...]:
    return (
        _workflow_protected_runtime_readiness_consumption_lease_constraint(prefix=prefix),
        _workflow_protected_runtime_readiness_consumption_outcome_constraint(prefix=prefix),
        ForeignKeyConstraint(
            [
                *_WF_RTREADY_SCOPE_COLUMNS,
                "authorization_claim_id",
...
class WorkflowProtectedRuntimeReadinessConsumptionClaimModel(
    _WorkflowProtectedRuntimeReadinessConsumptionSourceColumns,
    _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns,
    _WorkflowProtectedRuntimeReadinessAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_readiness_consumption_claims"
    __table_args__ = (
        *_workflow_protected_runtime_readiness_consumption_constraints(prefix="claim"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtready_cons_claim_lease"),
        UniqueConstraint("consumption_id", name="uq_wf_rtready_cons_claim_consumption"),
        UniqueConstraint("attempt_id", name="uq_wf_rtready_cons_claim_attempt"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtready_cons_claim_digest"),
        UniqueConstraint(
            "organization_id",
            "environment_id",
            "site_id",
        ...
        CheckConstraint(
            _WF_RTREADY_CONSUME_CONTRACT,
            name="ck_wf_rtready_cons_claim_contract",
        ),
        CheckConstraint(
            _WF_RTREADY_AUTH_SOURCE,
            name="ck_wf_rtready_cons_claim_source",
        ),
        CheckConstraint(
            "irreversible_consumption_acknowledged "
            "AND uncertainty_no_retry_acknowledged "
            ...
            "AND length(idempotency_digest) = 64 "
            "AND length(request_fingerprint) = 64 "
            "AND " + _WF_RTREADY_CONSUME_ZERO_AUTHORITY,
...
class WorkflowProtectedRuntimeReadinessConsumptionAttemptModel(
    _WorkflowProtectedRuntimeReadinessConsumptionSourceColumns,
    _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns,
    _WorkflowProtectedRuntimeReadinessAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_readiness_consumption_attempts"
    __table_args__ = (
        *_workflow_protected_runtime_readiness_consumption_constraints(prefix="attempt"),
        ForeignKeyConstraint(
            [
                "claim_id",
                "claim_digest",
            ...
            [
                "workflow_event_runtime_readiness_consumption_claims.claim_id",
                "workflow_event_runtime_readiness_consumption_claims.canonical_digest",
                "workflow_event_runtime_readiness_consumption_claims.consumption_id",
                "workflow_event_runtime_readiness_consumption_claims.attempt_id",
                "workflow_event_runtime_readiness_consumption_claims.authorization_lease_id",
            ],
            name="fk_wf_rtready_cons_attempt_claim",
        ),
        UniqueConstraint("claim_id", name="uq_wf_rtready_cons_attempt_claim"),
        UniqueConstraint("consumption_id", name="uq_wf_rtready_cons_attempt_consumption"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtready_cons_attempt_lease"),
        UniqueConstraint("instruction_digest", name="uq_wf_rtready_cons_attempt_instruction"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtready_cons_attempt_digest"),
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
            "claim_id",
            ...
            "authorization_lease_id",
            "authorization_lease_digest",
            name="uq_wf_rtproc_src_ready_attempt",
        ),
        UniqueConstraint(
            "attempt_id",
            "canonical_digest",
        ...
        CheckConstraint(
            _WF_RTREADY_CONSUME_CONTRACT,
            name="ck_wf_rtready_cons_attempt_contract",
        ),
        CheckConstraint(
            _WF_RTREADY_AUTH_SOURCE,
            name="ck_wf_rtready_cons_attempt_source",
        ),
        CheckConstraint(
    ...
    claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    protected_operation_reference: Mapped[str] = mapped_column(String(128), nullable=False)
    expected_assessment_count_pre: Mapped[int] = mapped_column(Integer, nullable=False)
    expected_assessment_count_post: Mapped[int] = mapped_column(Integer, nullable=False)
    assessor_contract_id: Mapped[str] = mapped_column(String(128), nullable=False)
    assessor_contract_version: Mapped[str] = mapped_column(String(64), nullable=False)
...
class WorkflowProtectedRuntimeReadinessConsumptionResultModel(
    _WorkflowProtectedRuntimeReadinessConsumptionSourceColumns,
    _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns,
    _WorkflowProtectedRuntimeReadinessAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_readiness_consumption_results"
    __table_args__ = (
        *_workflow_protected_runtime_readiness_consumption_constraints(prefix="result"),
        ForeignKeyConstraint(
            [
                "attempt_id",
                "attempt_digest",
            ...
            [
                "workflow_event_runtime_readiness_consumption_attempts.attempt_id",
                "workflow_event_runtime_readiness_consumption_attempts.canonical_digest",
                "workflow_event_runtime_readiness_consumption_attempts.claim_id",
                "workflow_event_runtime_readiness_consumption_attempts.claim_digest",
                "workflow_event_runtime_readiness_consumption_attempts.consumption_id",
                "workflow_event_runtime_readiness_consumption_attempts.authorization_lease_id",
                "workflow_event_runtime_readiness_consumption_attempts.authorization_lease_digest",
                "workflow_event_runtime_readiness_consumption_attempts.start_result_id",
                "workflow_event_runtime_readiness_consumption_attempts.start_result_digest",
                "workflow_event_runtime_readiness_consumption_attempts.destination_deployment_id",
                "workflow_event_runtime_readiness_consumption_attempts.destination_generation",
                "workflow_event_runtime_readiness_consumption_attempts.destination_fencing_token_digest",
                "workflow_event_runtime_readiness_consumption_attempts.runtime_slot_commitment",
                "workflow_event_runtime_readiness_consumption_attempts.runtime_slot_generation",
                "workflow_event_runtime_readiness_consumption_attempts.runtime_envelope_id",
                "workflow_event_runtime_readiness_consumption_attempts.runtime_envelope_commitment",
                "workflow_event_runtime_readiness_consumption_attempts.runtime_envelope_generation",
                "workflow_event_runtime_readiness_consumption_attempts.readiness_profile_id",
                "workflow_event_runtime_readiness_consumption_attempts.readiness_profile_version",
                "workflow_event_runtime_readiness_consumption_attempts.readiness_profile_digest",
                "workflow_event_runtime_readiness_consumption_attempts.protected_operation_reference",
                "workflow_event_runtime_readiness_consumption_attempts.instruction_digest",
                "workflow_event_runtime_readiness_consumption_attempts.started_at",
                "workflow_event_runtime_readiness_consumption_attempts.invocation_deadline",
            ],
            name="fk_wf_rtready_cons_result_attempt",
        ),
        UniqueConstraint("attempt_id", name="uq_wf_rtready_cons_result_attempt"),
        UniqueConstraint("claim_id", name="uq_wf_rtready_cons_result_claim"),
        UniqueConstraint("consumption_id", name="uq_wf_rtready_cons_result_consumption"),
        UniqueConstraint("authorization_lease_id", name="uq_wf_rtready_cons_result_lease"),
        UniqueConstraint("canonical_digest", name="uq_wf_rtready_cons_result_digest"),
        UniqueConstraint(
            "organization_id",
            "environment_id",
            "site_id",
            ...
            "authorization_lease_id",
            "authorization_lease_digest",
            name="uq_wf_rtproc_src_ready_result_lineage",
        ),
        UniqueConstraint(
            "organization_id",
            "environment_id",
            ...
            "completed_at",
            "recorded_at",
            name="uq_wf_rtproc_src_ready_result_outcome",
        ),
        CheckConstraint(
            _WF_RTREADY_CONSUME_CONTRACT,
            name="ck_wf_rtready_cons_result_contract",
        ),
        CheckConstraint(
            _WF_RTREADY_AUTH_SOURCE,
            name="ck_wf_rtready_cons_result_source",
        ),
        CheckConstraint(
            "recorded_at >= started_at AND "
    ...
    failure_class: Mapped[str | None] = mapped_column(String(64), nullable=True)
    outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    assessment_performed: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    runtime_ready: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    assessor_receipt_digest: Mapped[str | None] = mapped_column(String(64), nullable=True)
    completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    recorded_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    canonical_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    payload: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False)
    assessor_receipt_payload: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)


_WF_RTPROC_AUTH_POLICY_DIGEST = "864620a2296233207d3ff1bde932725f65df1c102bddbdca304f9bcfe7e0cc96"
_WF_RTPROC_AUTH_PROFILE_DIGEST = "b08432f01dd864b34157e2522fc591606487a6d0968d2f39dd88a5672aa0ba1b"
_WF_RTPROC_AUTH_CONTRACT = (
    "consumer_subject_id = "
    "'service.workflow-protected-transport-target-context-capsule-consumer' "
    "AND consumer_audience = "
    "'audience.workflow-protected-transport-target-context-capsule-consumer' "
    ...
    "AND policy_version = '1.0' "
    f"AND policy_digest = '{_WF_RTPROC_AUTH_POLICY_DIGEST}' "
    "AND source_policy_id = 'policy.workflow-protected-runtime-readiness-consumption' "
    "AND source_policy_version = '1.0' "
    f"AND source_policy_digest = '{_WF_RTREADY_CONSUME_POLICY_DIGEST}'"
)
_WF_RTPROC_AUTH_ZERO_AUTHORITY = (
    _WF_RTREADY_CONSUME_ZERO_AUTHORITY
    + " AND NOT protected_runtime_process_creation_authority_granted"
)
_WF_RTPROC_AUTH_READY_SOURCE = (
    "readiness_result_state = 'runtime_ready_in_protected_boundary' "
    "AND readiness_outcome_known AND readiness_assessment_performed "
    "AND runtime_ready AND readiness_failure_class IS NULL "
    "AND readiness_completed_at IS NOT NULL "
    "AND assessor_receipt_digest IS NOT NULL "
    ...
    "AND coordination_state = 'start_attempt_terminal' "
    "AND NOT runtime_start_attempt_pending AND runtime_start_attempt_terminal "
    "AND runtime_started AND NOT runtime_resumed "
    "AND NOT process_created AND NOT process_scheduled "
    "AND runtime_slot_generation = runtime_envelope_generation "
    "AND runtime_slot_generation >= 2"
)


class _WorkflowProtectedRuntimeProcessCreationAuthorizationAuthorityColumns(
    _WorkflowProtectedRuntimeReadinessAuthorizationAuthorityColumns
):
    protected_runtime_process_creation_authority_granted: Mapped[bool] = mapped_column(
        Boolean, nullable=False
    )


class _WorkflowProtectedRuntimeProcessCreationAuthorizationSourceColumns(
    _WorkflowProtectedRuntimeReadinessAuthorizationSourceColumns
):
    readiness_result_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_result_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_consumption_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_attempt_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_attempt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_authorization_lease_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_authorization_lease_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_authorization_claim_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_authorization_claim_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_profile_id: Mapped[str] = mapped_column(String(128), nullable=False)
    readiness_profile_version: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_profile_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    readiness_invocation_deadline: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    readiness_result_state: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_failure_class: Mapped[str | None] = mapped_column(String(64), nullable=True)
    readiness_outcome_known: Mapped[bool] = mapped_column(Boolean, nullable=False)
    readiness_assessment_performed: Mapped[bool] = mapped_column(Boolean, nullable=False)
    runtime_ready: Mapped[bool] = mapped_column(Boolean, nullable=False)
    assessor_receipt_digest: Mapped[str] = mapped_column(String(64), nullable=False)
    readiness_completed_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )
    readiness_result_recorded_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), nullable=False
    )


_WF_RTPROC_RESULT_LINEAGE_COLUMNS = (
    "organization_id",
    "environment_id",
    "site_id",
    "readiness_result_id",
...
def _workflow_protected_runtime_process_creation_source_constraints(
    *, prefix: str
) -> tuple[ForeignKeyConstraint, ...]:
    result_remote = (
        "organization_id",
    ...
    return (
        ForeignKeyConstraint(
            _WF_RTPROC_RESULT_LINEAGE_COLUMNS,
            [
                f"workflow_event_runtime_readiness_consumption_results.{name}"
                for name in result_remote
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_readiness_consumption_results.organization_id",
                "workflow_event_runtime_readiness_consumption_results.environment_id",
                "workflow_event_runtime_readiness_consumption_results.site_id",
                "workflow_event_runtime_readiness_consumption_results.result_id",
                "workflow_event_runtime_readiness_consumption_results.canonical_digest",
                "workflow_event_runtime_readiness_consumption_results.state",
                "workflow_event_runtime_readiness_consumption_results.outcome_known",
                "workflow_event_runtime_readiness_consumption_results.assessment_performed",
                "workflow_event_runtime_readiness_consumption_results.runtime_ready",
                "workflow_event_runtime_readiness_consumption_results.assessor_receipt_digest",
                "workflow_event_runtime_readiness_consumption_results.started_at",
                "workflow_event_runtime_readiness_consumption_results.invocation_deadline",
                "workflow_event_runtime_readiness_consumption_results.completed_at",
                "workflow_event_runtime_readiness_consumption_results.recorded_at",
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_readiness_auth_leases.authorization_lease_id",
                "workflow_event_runtime_readiness_auth_leases.canonical_digest",
                "workflow_event_runtime_readiness_auth_leases.claim_id",
                "workflow_event_runtime_readiness_auth_leases.claim_digest",
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_readiness_auth_claims.organization_id",
                "workflow_event_runtime_readiness_auth_claims.environment_id",
                "workflow_event_runtime_readiness_auth_claims.site_id",
                "workflow_event_runtime_readiness_auth_claims.claim_id",
                "workflow_event_runtime_readiness_auth_claims.canonical_digest",
                "workflow_event_runtime_readiness_auth_claims.authorization_lease_id",
            ],
        ...
        ForeignKeyConstraint(
            ...
            [
                "workflow_event_runtime_start_coordination_heads.organization_id",
                "workflow_event_runtime_start_coordination_heads.environment_id",
                "workflow_event_runtime_start_coordination_heads.site_id",
                "workflow_event_runtime_start_coordination_heads.runtime_envelope_id",
                "workflow_event_runtime_start_coordination_heads.runtime_envelope_commitment",
                "workflow_event_runtime_start_coordination_heads.runtime_envelope_generation",
                "workflow_event_runtime_start_coordination_heads.use_result_id",
...
class WorkflowProtectedRuntimeProcessCreationAuthorizationLeaseModel(
    ...
    __table_args__ = (
        *_workflow_protected_runtime_process_creation_source_constraints(prefix="lease"),
        ...
        UniqueConstraint(
            "authorization_lease_id",
            "claim_digest",
            name="uq_wf_rtproc_auth_lease_claim_digest",
        ),
        UniqueConstraint("canonical_digest", name="uq_wf_rtproc_auth_lease_digest"),
        CheckConstraint(_WF_RTPROC_AUTH_CONTRACT, name="ck_wf_rtproc_auth_lease_contract"),
        CheckConstraint(_WF_RTPROC_AUTH_READY_SOURCE, name="ck_wf_rtproc_auth_lease_source"),
        CheckConstraint(
            "claimed_at <= issued_at AND issued_at < valid_until "
            "AND valid_until = effective_until "
            "AND valid_until <= issued_at + INTERVAL '1 second' "
            "AND source_observed_at <= authorized_at "
            "AND source_observed_at = claimed_at AND authorized_at = issued_at "
            "AND effective_until <= lifecycle_attestation_valid_until "
            "AND effective_until <= runtime_envelope_eligible_until "
            ...
            "AND state = 'authorized_unconsumed' "
            "AND protected_runtime_process_creation_authority_granted "
            "AND " + _WF_RTREADY_CONSUME_ZERO_AUTHORITY,
...
class WorkflowProtectedRuntimeProcessCreationAuthorizationClaimModel(
    _WorkflowProtectedRuntimeProcessCreationAuthorizationSourceColumns,
    _WorkflowProtectedRuntimeStartAuthorizationIdentityColumns,
    _WorkflowProtectedRuntimeProcessCreationAuthorizationAuthorityColumns,
    Base,
):
    __tablename__ = "workflow_event_runtime_process_creation_auth_claims"
    __table_args__ = (
        *_workflow_protected_runtime_process_creation_source_constraints(prefix="claim"),
        ForeignKeyConstraint(
            ["authorization_lease_id", "canonical_digest"],
            [
                "workflow_event_runtime_process_creation_auth_leases.authorization_lease_id",
        ...
        CheckConstraint(_WF_RTPROC_AUTH_CONTRACT, name="ck_wf_rtproc_auth_claim_contract"),
        CheckConstraint(_WF_RTPROC_AUTH_READY_SOURCE, name="ck_wf_rtproc_auth_claim_source"),
        CheckConstraint(
            "source_observed_at = claimed_at "
            "AND readiness_result_recorded_at <= claimed_at "
            "AND length(idempotency_scope_id) = 64 "
            "AND length(idempotency_digest) = 64 "
            "AND length(request_fingerprint) = 64 "
            "AND length(authorization_audit_digest) = 64 "
            "AND " + _WF_RTPROC_AUTH_ZERO_AUTHORITY,
