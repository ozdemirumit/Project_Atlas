...
def definition() -> HealthCheckDefinition:
    controller, capacity, fabric = build_synthetic_health_check_definitions(
        organization_id="organization.atlas.local",
        environment="development",
        anchor_at=NOW,
    )
    del controller, capacity
    return replace(
        fabric,
...
async def test_other_definitions_are_delegated_to_the_fallback_executor() -> None:
    ...
    controller, _capacity, _fabric = build_synthetic_health_check_definitions(
        organization_id="organization.atlas.local",
        environment="development",
        anchor_at=NOW,
    )
