...
async def _authorization_request(
    ...
    *,
    ...
    attestation_request = WorkflowProtectedRuntimeProcessSchedulingStateAttestationRequest(
        ...
        destination_deployment_id=creation_lease.destination_deployment_id,
        destination_generation=creation_lease.destination_generation,
        destination_fencing_token_digest=creation_lease.destination_fencing_token_digest,
        protected_slot_commitment=creation_lease.protected_slot_commitment,
        protected_slot_generation=creation_lease.protected_slot_generation,
        runtime_envelope_id=result.runtime_envelope_id,
