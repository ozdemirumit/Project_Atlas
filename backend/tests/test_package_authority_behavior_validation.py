...
def test_authority_behavior_api_requires_authentication() -> None:
    ...
    with TestClient(create_app(Settings(environment="test"))) as client:
        created = client.post(
            ...
            json={
                "source_schema_semantics_validation_id": "validation.wiring-denied-0001",
                "source_schema_semantics_validation_digest": "f" * 64,
                "package_digest": "f" * 64,
                "acknowledged_static_analysis_limitations": True,
            },
            headers={"Idempotency-Key": "authority-behavior-denied-0001"},
        )
        read = client.get(
            "/api/v1/connectors/package-authority-behavior-validations/"
            "authority-behavior-validation.wiring-denied-0001"
        )
...
def test_authority_behavior_api_requires_permission() -> None:
    ...
    with TestClient(create_app(_settings(development_role_ids=()))) as client:
        ...
        created = client.post(
            ...
            headers={
                "X-CSRF-Token": csrf,
                "Idempotency-Key": "authority-behavior-denied-0002",
            },
        )
        read = client.get(
            "/api/v1/connectors/package-authority-behavior-validations/"
