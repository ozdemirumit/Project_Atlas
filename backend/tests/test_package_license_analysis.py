...
def test_license_api_requires_authentication() -> None:
    ...
    with TestClient(create_app(Settings(environment="test"))) as client:
        created = client.post(
            "/api/v1/connectors/package-license-analyses",
            json={
                "source_malware_analysis_id": "malware-analysis.wiring-denied-0001",
                "source_malware_analysis_digest": "f" * 64,
                "package_digest": "f" * 64,
                "acknowledged_policy_not_legal_advice": True,
            },
            headers={"Idempotency-Key": "license-analysis-denied-0001"},
        )
        read = client.get(
            "/api/v1/connectors/package-license-analyses/license-analysis.wiring-denied-0001"
        )
...
def test_license_api_requires_permission() -> None:
    ...
    with TestClient(create_app(_settings(development_role_ids=()))) as client:
        ...
        created = client.post(
            ...
            headers={
                "X-CSRF-Token": csrf,
                "Idempotency-Key": "license-analysis-denied-0002",
            },
        )
        read = client.get(
            "/api/v1/connectors/package-license-analyses/license-analysis.wiring-denied-0001",
